...
export const dict: Record<I18nKey, string> = {
  ...
  "commandPalette.item.openGraphs": "Abrir grafos",
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': 'Grafos',
  'rungraph.toolbar.new': 'Nuevo',
  'rungraph.toolbar.save': 'Guardar',
  'rungraph.toolbar.delete': 'Eliminar',
  'rungraph.toolbar.run': 'Ejecutar',
  'rungraph.toolbar.stop': 'Detener',
  'rungraph.toolbar.addRun': 'Añadir ejecución',
  'rungraph.toolbar.addWorktree': 'Añadir worktree',
  'rungraph.toolbar.validation': 'Validación',
  'rungraph.toolbar.validationOk': 'No se encontraron problemas',
  'rungraph.toolbar.saved': 'Grafo guardado',
  'rungraph.toolbar.saveFailed': 'No se pudo guardar el grafo',
  'rungraph.editor.nodeTitle': 'Título del nodo',
  'rungraph.editor.agent': 'Agente',
  'rungraph.editor.models': 'Modelos',
  'rungraph.editor.prompt': 'Plantilla de prompt',
  'rungraph.editor.promptHint': 'Usa variables como {{name}} para incluir las entradas conectadas.',
  'rungraph.editor.worktree': 'Worktree',
  'rungraph.editor.nodeWorktree': 'Worktree del nodo',
  'rungraph.editor.nodeWorktreeNone': 'Raíz del proyecto',
  'rungraph.editor.selectNodeHint': 'Selecciona un nodo de ejecución o worktree para editarlo.',
  'rungraph.empty.title': 'Empieza a crear tu grafo',
  'rungraph.sessions.title': 'Sesiones',
  'rungraph.editor.inputs': 'Entradas',
  'rungraph.empty.description': 'Añade un nodo de ejecución con un prompt de agente y modelos, y conecta las salidas en otras ejecuciones. Los nodos de worktree ejecutan agentes en un worktree de git compartido o nuevo.',
  'rungraph.editor.worktreeInherit': 'Predeterminado del nodo',
  'rungraph.editor.worktreeRoot': 'Raíz del proyecto',
  'rungraph.editor.worktreePool': 'Compartido: {name}',
  'rungraph.editor.worktreeDedicated': 'Nuevo worktree dedicado',
  'rungraph.worktree.kindExisting': 'Existente',
  'rungraph.worktree.kindNew': 'Nuevo',
  'rungraph.worktree.path': 'Ruta',
  'rungraph.worktree.name': 'Nombre',
  'rungraph.worktree.baseBranch': 'Rama base',
  'rungraph.worktree.setupCommands': 'Comandos de configuración',
  'rungraph.status.pending': 'Pendiente',
  'rungraph.status.starting': 'Iniciando',
  'rungraph.status.running': 'Ejecutando',
  'rungraph.status.done': 'Completado',
  'rungraph.status.failed': 'Fallido',
  'rungraph.status.blocked': 'Bloqueado',
  'rungraph.status.skipped': 'Omitido',
  'rungraph.outputs.title': 'Salida',
  'rungraph.outputs.empty': 'Aún no hay salida',
  'rungraph.openSession': 'Abrir sesión',
  'rungraph.issue.emptyGraph': 'El grafo necesita al menos un nodo de ejecución.',
  'rungraph.issue.duplicateTitle': 'El título "{title}" se usa más de una vez.',
  'rungraph.issue.nodeMissingInstances': '"{title}" necesita al menos un modelo.',
  'rungraph.issue.nodeTooManyInstances': '"{title}" supera el máximo de 5 modelos.',
  'rungraph.issue.instanceMissingModel': '"{title}" tiene una entrada de modelo sin proveedor o modelo.',
  'rungraph.issue.edgeDanglingNode': 'Una conexión hace referencia a un nodo inexistente.',
  'rungraph.issue.edgeDanglingInstance': 'Una conexión hace referencia a una salida de modelo inexistente.',
  'rungraph.issue.edgeDuplicate': 'Ya existe una conexión duplicada entre la misma salida y nodo.',
  'rungraph.issue.edgeSelf': 'Un nodo no puede ser su propia entrada.',
  'rungraph.issue.edgeCycle': '"{title}" forma parte de un ciclo de dependencias.',
  'rungraph.issue.templateSyntax': '"{title}" tiene una expresión de plantilla no válida.',
  'rungraph.issue.templateNoInputs': '"{title}" hace referencia a "{name}" pero no hay nada conectado a ella.',
  'rungraph.issue.templateInputRange': '"{title}" hace referencia a "{name}[N]" pero la entrada tiene menos valores conectados.',
  'rungraph.issue.bindingDangling': 'Un nodo hace referencia a un worktree inexistente.',
  'rungraph.issue.worktreeMissingPath': 'El worktree "{title}" necesita una ruta.',
  'rungraph.issue.worktreeMissingName': 'El worktree "{title}" necesita un nombre.',
  'rungraph.issue.worktreeDuplicateTitle': 'El título del worktree "{title}" se usa más de una vez.',
  'rungraph.issue.instancePoolDangling': '"{title}" hace referencia a un worktree inexistente.',
  'rungraph.issue.sharedWorktree': '{count} ejecuciones comparten el worktree "{title}" y se ejecutarán a la vez.',
  'rungraph.issue.worktreeOrphan': 'El worktree "{title}" no lo usa ninguna ejecución.',
  'rungraph.editor.nodeInputs': 'Entradas',
  'rungraph.editor.addInput': 'Añadir entrada',
  'rungraph.editor.inputName': 'Nombre de la entrada',
  'rungraph.editor.inputNamePlaceholder': 'p. ej. tema',
  'rungraph.editor.removeInput': 'Eliminar entrada',
  'rungraph.editor.noInputs': 'Aún no hay entradas con nombre. Añade una, conecta salidas a ella y referénciala en la instrucción.',
  'rungraph.editor.insertVariable': 'Insertar variable',
  'rungraph.issue.edgeInputTargetInvalid': 'Una conexión hacia "{title}" no apunta a una entrada existente.',
  'rungraph.issue.inputMissingName': 'El nodo "{title}" tiene una entrada sin nombre.',
  'rungraph.issue.inputDuplicateName': 'El nodo "{title}" usa el nombre de entrada "{name}" más de una vez.',
  'rungraph.issue.inputInvalidName': 'El nodo "{title}" tiene un nombre de entrada no válido "{name}".',
  'rungraph.issue.templateUnknownInput': '"{title}" hace referencia a "{name}" pero no tiene ninguna entrada con ese nombre.',
  'rungraph.toolbar.addForm': 'Añadir formulario',
  'rungraph.form.badge': 'Formulario',
  'rungraph.form.noFields': 'Aún no hay campos',
  'rungraph.form.description': 'Los campos del formulario se convierten en salidas que puedes conectar a las instrucciones de otras ejecuciones. Cada formulario aparece durante la ejecución del grafo, justo antes de que una ejecución lo necesite.',
  'rungraph.scope.location': 'Ubicación de guardado',
  'rungraph.scope.project': 'Proyecto',
  'rungraph.scope.global': 'Global',
  'rungraph.form.fields': 'Campos',
  'rungraph.form.addField': 'Añadir campo',
  'rungraph.form.fieldTitle': 'Título del campo',
  'rungraph.form.fieldTitlePlaceholder': '¿Para qué sirve este campo?',
  'rungraph.form.fieldType': 'Tipo',
  'rungraph.form.fieldType.text': 'Texto',
  'rungraph.form.fieldType.textarea': 'Párrafo',
  'rungraph.form.fieldType.number': 'Número',
  'rungraph.form.fieldType.date': 'Fecha',
  'rungraph.form.fieldType.time': 'Hora',
  'rungraph.form.fieldType.select': 'Lista desplegable',
  'rungraph.form.fieldType.slider': 'Deslizador',
  'rungraph.form.fieldType.checkbox': 'Casilla',
  'rungraph.form.removeField': 'Eliminar campo',
  'rungraph.form.fieldPlaceholder': 'Texto de ejemplo',
  'rungraph.form.fieldOptions': 'Opciones (una por línea)',
  'rungraph.form.fieldOptionsPlaceholder': 'Opción A\nOpción B',
  'rungraph.form.fieldMin': 'Mín',
  'rungraph.form.fieldMax': 'Máx',
  'rungraph.form.fieldStep': 'Paso',
  'rungraph.form.fieldRequired': 'Obligatorio',
  'rungraph.form.fieldDefault': 'Valor predeterminado',
  'rungraph.form.fieldDefaultNone': 'Ninguno',
  'rungraph.form.defaults': 'Valores predeterminados inyectados',
  'rungraph.form.dialog.description': 'Rellena este formulario para continuar la ejecución del grafo.',
  'rungraph.form.dialog.submit': 'Enviar',
  'rungraph.form.dialog.cancel': 'Cancelar',
  'rungraph.form.dialog.enabled': 'Activado',
  'rungraph.form.dialog.disabled': 'Desactivado',
  'rungraph.issue.edgeSourcePortInvalid': 'Una conexión desde "{title}" no apunta a una salida existente.',
  'rungraph.issue.edgeFormTargetInvalid': 'Una conexión hacia "{title}" no apunta a un campo de formulario existente.',
  'rungraph.issue.formMissingFields': 'El formulario "{title}" necesita al menos un campo.',
  'rungraph.issue.formFieldMissingTitle': 'El formulario "{title}" tiene un campo sin título.',
  'rungraph.issue.formFieldDuplicateTitle': 'El formulario "{title}" usa el título de campo "{field}" más de una vez.',
  'rungraph.issue.formFieldSelectOptions': 'El formulario "{title}" tiene un campo desplegable sin opciones.',
  'rungraph.issue.formFieldSliderBounds': 'El formulario "{title}" tiene un deslizador sin valor mínimo y máximo.',
  'rungraph.issue.formFieldRange': 'El formulario "{title}" tiene un campo cuyo mínimo supera su máximo.',
  'rungraph.issue.formUnused': 'El formulario "{title}" no está conectado a ninguna ejecución y no se mostrará.',
};
