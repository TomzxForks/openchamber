...
export const dict: Record<I18nKey, string> = {
  ...
  'commandPalette.item.openGraphs': '그래프 열기',
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': '그래프',
  'rungraph.toolbar.new': '새로 만들기',
  'rungraph.toolbar.save': '저장',
  'rungraph.toolbar.delete': '삭제',
  'rungraph.toolbar.run': '실행',
  'rungraph.toolbar.stop': '중지',
  'rungraph.toolbar.addRun': '실행 노드 추가',
  'rungraph.toolbar.addWorktree': '워크트리 추가',
  'rungraph.toolbar.validation': '검증',
  'rungraph.toolbar.validationOk': '문제가 없습니다',
  'rungraph.toolbar.saved': '그래프를 저장했습니다',
  'rungraph.toolbar.saveFailed': '그래프를 저장하지 못했습니다',
  'rungraph.editor.nodeTitle': '노드 제목',
  'rungraph.editor.agent': '에이전트',
  'rungraph.editor.models': '모델',
  'rungraph.editor.prompt': '프롬프트 템플릿',
  'rungraph.editor.promptHint': '{{name}} 같은 변수로 연결된 입력을 포함합니다.',
  'rungraph.editor.worktree': '워크트리',
  'rungraph.editor.nodeWorktree': '노드 워크트리',
  'rungraph.editor.nodeWorktreeNone': '프로젝트 루트',
  'rungraph.editor.selectNodeHint': '편집할 실행 노드나 워크트리 노드를 선택하세요.',
  'rungraph.empty.title': '그래프 만들기를 시작하세요',
  'rungraph.sessions.title': '세션',
  'rungraph.editor.inputs': '입력',
  'rungraph.empty.description': '에이전트 프롬프트와 모델이 있는 실행 노드를 추가하고 출력을 다른 실행에 연결하세요. 워크트리 노드는 공유되거나 새로운 git 워크트리에서 에이전트를 실행합니다.',
  'rungraph.editor.worktreeInherit': '노드 기본값',
  'rungraph.editor.worktreeRoot': '프로젝트 루트',
  'rungraph.editor.worktreePool': '공유: {name}',
  'rungraph.editor.worktreeDedicated': '새 전용 워크트리',
  'rungraph.worktree.kindExisting': '기존',
  'rungraph.worktree.kindNew': '새로 만들기',
  'rungraph.worktree.path': '경로',
  'rungraph.worktree.name': '이름',
  'rungraph.worktree.baseBranch': '베이스 브랜치',
  'rungraph.worktree.setupCommands': '설정 명령',
  'rungraph.status.pending': '대기 중',
  'rungraph.status.starting': '시작 중',
  'rungraph.status.running': '실행 중',
  'rungraph.status.done': '완료',
  'rungraph.status.failed': '실패',
  'rungraph.status.blocked': '차단됨',
  'rungraph.status.skipped': '건너뜀',
  'rungraph.outputs.title': '출력',
  'rungraph.outputs.empty': '아직 출력이 없습니다',
  'rungraph.openSession': '세션 열기',
  'rungraph.issue.emptyGraph': '그래프에는 최소 하나의 실행 노드가 필요합니다.',
  'rungraph.issue.duplicateTitle': '제목 "{title}"이(가) 여러 번 사용되었습니다.',
  'rungraph.issue.nodeMissingInstances': '"{title}"에는 최소 하나의 모델이 필요합니다.',
  'rungraph.issue.nodeTooManyInstances': '"{title}"이(가) 최대 모델 수 5개를 초과했습니다.',
  'rungraph.issue.instanceMissingModel': '"{title}"에 공급자 또는 모델이 없는 모델 항목이 있습니다.',
  'rungraph.issue.edgeDanglingNode': '연결이 존재하지 않는 노드를 참조합니다.',
  'rungraph.issue.edgeDanglingInstance': '연결이 존재하지 않는 모델 출력을 참조합니다.',
  'rungraph.issue.edgeDuplicate': '동일한 출력과 노드 사이에 중복 연결이 존재합니다.',
  'rungraph.issue.edgeSelf': '노드는 자기 자신의 입력이 될 수 없습니다.',
  'rungraph.issue.edgeCycle': '"{title}"은(는) 의존성 순환의 일부입니다.',
  'rungraph.issue.templateSyntax': '"{title}"에 잘못된 템플릿 표현식이 있습니다.',
  'rungraph.issue.templateNoInputs': '"{title}"이(가) "{name}"을(를) 참조하지만 연결된 것이 없습니다.',
  'rungraph.issue.templateInputRange': '"{title}"이(가) "{name}[N]"을(를) 참조하지만 연결된 값이 부족합니다.',
  'rungraph.issue.bindingDangling': '노드가 존재하지 않는 워크트리를 참조합니다.',
  'rungraph.issue.worktreeMissingPath': '워크트리 "{title}"에는 경로가 필요합니다.',
  'rungraph.issue.worktreeMissingName': '워크트리 "{title}"에는 이름이 필요합니다.',
  'rungraph.issue.worktreeDuplicateTitle': '워크트리 제목 "{title}"이(가) 여러 번 사용되었습니다.',
  'rungraph.issue.instancePoolDangling': '"{title}"이(가) 존재하지 않는 워크트리를 참조합니다.',
  'rungraph.issue.sharedWorktree': '{count}개의 실행이 워크트리 "{title}"을(를) 공유하며 동시에 실행됩니다.',
  'rungraph.issue.worktreeOrphan': '워크트리 "{title}"은(는) 어떤 실행에서도 사용되지 않습니다.',
  'rungraph.editor.nodeInputs': '입력',
  'rungraph.editor.addInput': '입력 추가',
  'rungraph.editor.inputName': '입력 이름',
  'rungraph.editor.inputNamePlaceholder': '예: topic',
  'rungraph.editor.removeInput': '입력 삭제',
  'rungraph.editor.noInputs': '아직 이름 붙은 입력이 없습니다. 하나 추가하고 출력을 연결한 뒤 프롬프트에서 참조하세요.',
  'rungraph.editor.insertVariable': '변수 삽입',
  'rungraph.issue.edgeInputTargetInvalid': '"{title}"으로 들어가는 연결이 기존 입력을 가리키지 않습니다.',
  'rungraph.issue.inputMissingName': '노드 "{title}"에 이름 없는 입력이 있습니다.',
  'rungraph.issue.inputDuplicateName': '노드 "{title}"에서 입력 이름 "{name}"을(를) 여러 번 사용합니다.',
  'rungraph.issue.inputInvalidName': '노드 "{title}"에 잘못된 입력 이름 "{name}"이(가) 있습니다.',
  'rungraph.issue.templateUnknownInput': '"{title}"이(가) "{name}"을(를) 참조하지만 그런 이름의 입력이 없습니다.',
  'rungraph.toolbar.addForm': '양식 추가',
  'rungraph.form.badge': '양식',
  'rungraph.form.noFields': '아직 필드가 없습니다',
  'rungraph.form.description': '양식 필드는 실행 프롬프트에 연결할 수 있는 출력이 됩니다. 각 양식은 그래프 실행 중에 해당 정보가 필요해지는 바로 그 시점에 표시됩니다.',
  'rungraph.scope.location': '저장 위치',
  'rungraph.scope.project': '프로젝트',
  'rungraph.scope.global': '전역',
  'rungraph.form.fields': '필드',
  'rungraph.form.addField': '필드 추가',
  'rungraph.form.fieldTitle': '필드 제목',
  'rungraph.form.fieldTitlePlaceholder': '이 필드는 어떤 용도인가요?',
  'rungraph.form.fieldType': '유형',
  'rungraph.form.fieldType.text': '텍스트',
  'rungraph.form.fieldType.textarea': '단락',
  'rungraph.form.fieldType.number': '숫자',
  'rungraph.form.fieldType.date': '날짜',
  'rungraph.form.fieldType.time': '시간',
  'rungraph.form.fieldType.select': '드롭다운',
  'rungraph.form.fieldType.slider': '슬라이더',
  'rungraph.form.fieldType.checkbox': '체크박스',
  'rungraph.form.removeField': '필드 삭제',
  'rungraph.form.fieldPlaceholder': '플레이스홀더',
  'rungraph.form.fieldOptions': '옵션 (한 줄에 하나)',
  'rungraph.form.fieldOptionsPlaceholder': '옵션 A\n옵션 B',
  'rungraph.form.fieldMin': '최소',
  'rungraph.form.fieldMax': '최대',
  'rungraph.form.fieldStep': '단계',
  'rungraph.form.fieldRequired': '필수',
  'rungraph.form.fieldDefault': '기본값',
  'rungraph.form.fieldDefaultNone': '없음',
  'rungraph.form.defaults': '주입된 기본값',
  'rungraph.form.dialog.description': '그래프 실행을 계속하려면 이 양식을 작성하세요.',
  'rungraph.form.dialog.submit': '제출',
  'rungraph.form.dialog.cancel': '취소',
  'rungraph.form.dialog.enabled': '켜짐',
  'rungraph.form.dialog.disabled': '꺼짐',
  'rungraph.issue.edgeSourcePortInvalid': '"{title}"에서 나가는 연결이 기존 출력을 가리키지 않습니다.',
  'rungraph.issue.edgeFormTargetInvalid': '"{title}"으로 들어가는 연결이 기존 양식 필드를 가리키지 않습니다.',
  'rungraph.issue.formMissingFields': '양식 "{title}"에는 최소한 하나의 필드가 필요합니다.',
  'rungraph.issue.formFieldMissingTitle': '양식 "{title}"에 제목 없는 필드가 있습니다.',
  'rungraph.issue.formFieldDuplicateTitle': '양식 "{title}"에서 필드 제목 "{field}"을(를) 여러 번 사용합니다.',
  'rungraph.issue.formFieldSelectOptions': '양식 "{title}"에 옵션이 없는 드롭다운 필드가 있습니다.',
  'rungraph.issue.formFieldSliderBounds': '양식 "{title}"에 최솟값과 최댓값이 없는 슬라이더 필드가 있습니다.',
  'rungraph.issue.formFieldRange': '양식 "{title}"에 최솟값이 최댓값보다 큰 필드가 있습니다.',
  'rungraph.issue.formUnused': '양식 "{title}"은(는) 어떤 실행에도 연결되어 있지 않아 표시되지 않습니다.',
};
