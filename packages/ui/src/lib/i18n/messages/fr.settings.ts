...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.openchamber.visual.field.messageTimestampFormat': 'Heure du message',
  'settings.openchamber.visual.field.selectMessageTimestampFormatAria': 'Choisir le format d’heure du message',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.label': 'Masqué',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.description': 'Ne pas afficher la date/heure sur les messages.',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.label': 'Relatif',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.description': 'Afficher le temps écoulé, ex. « il y a 2 h 15 ».',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.label': 'Absolu',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.description': 'Afficher l’horodatage exact.',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.label': 'Hybride',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.description': 'Relatif jusqu’au seuil d’âge du message, puis absolu.',
  'settings.openchamber.visual.field.messageTimestampHybridThreshold': 'Durée avant de passer en absolu (ex. 1d 2h 30m)',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdDays': 'jours',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdHours': 'heures',
