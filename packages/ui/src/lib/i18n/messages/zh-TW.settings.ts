...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.field.messageTimestampFormat': '訊息時間',
  'settings.openchamber.visual.field.selectMessageTimestampFormatAria': '選擇訊息時間格式',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.label': '隱藏',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.description': '不在訊息上顯示日期/時間。',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.label': '相對',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.description': '顯示經過時間，例如「2小時2分鐘前」。',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.label': '絕對',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.description': '顯示確切的時間戳記。',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.label': '混合',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.description': '訊息達到閾值年齡前顯示相對時間，之後顯示絕對時間。',
  'settings.openchamber.visual.field.messageTimestampHybridThreshold': '切換為絕對顯示前的時長（例如 1d 2h 30m）',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdDays': '天',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdHours': '小時',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdMinutes': '分鐘',
