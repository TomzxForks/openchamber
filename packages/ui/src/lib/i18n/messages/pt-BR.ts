...
export const dict: Record<I18nKey, string> = {
  ...
  'rungraph.toolbar.new': 'Novo',
  'rungraph.toolbar.save': 'Salvar',
  'rungraph.toolbar.delete': 'Excluir',
  'rungraph.toolbar.run': 'Executar',
  'rungraph.toolbar.stop': 'Parar',
  'rungraph.toolbar.addRun': 'Adicionar execução',
  'rungraph.toolbar.addWorktree': 'Adicionar worktree',
  'rungraph.toolbar.validation': 'Validação',
  'rungraph.toolbar.validationOk': 'Nenhum problema encontrado',
  'rungraph.toolbar.saved': 'Grafo salvo',
  'rungraph.toolbar.saveFailed': 'Falha ao salvar o grafo',
  'rungraph.editor.nodeTitle': 'Título do nó',
  'rungraph.editor.agent': 'Agente',
  'rungraph.editor.models': 'Modelos',
  'rungraph.editor.prompt': 'Modelo de prompt',
  'rungraph.editor.promptHint': 'Use variáveis como {{name}} para incluir as entradas conectadas.',
  'rungraph.editor.worktree': 'Worktree',
  'rungraph.editor.nodeWorktree': 'Worktree do nó',
  'rungraph.editor.nodeWorktreeNone': 'Raiz do projeto',
  'rungraph.editor.selectNodeHint': 'Selecione um nó de execução ou worktree para editá-lo.',
  'rungraph.empty.title': 'Comece a montar seu grafo',
  'rungraph.sessions.title': 'Sessões',
  'rungraph.editor.inputs': 'Entradas',
  'rungraph.empty.description': 'Adicione um nó de execução com um prompt de agente e modelos, depois conecte as saídas em outras execuções. Nós de worktree executam agentes em um worktree git compartilhado ou novo.',
  'rungraph.editor.worktreeInherit': 'Padrão do nó',
  'rungraph.editor.worktreeRoot': 'Raiz do projeto',
  'rungraph.editor.worktreePool': 'Compartilhado: {name}',
  'rungraph.editor.worktreeDedicated': 'Novo worktree dedicado',
  'rungraph.worktree.kindExisting': 'Existente',
  'rungraph.worktree.kindNew': 'Novo',
  'rungraph.worktree.path': 'Caminho',
  'rungraph.worktree.name': 'Nome',
  'rungraph.worktree.baseBranch': 'Branch base',
  'rungraph.worktree.setupCommands': 'Comandos de configuração',
  'rungraph.status.pending': 'Pendente',
  'rungraph.status.starting': 'Iniciando',
  'rungraph.status.running': 'Executando',
  'rungraph.status.done': 'Concluído',
  'rungraph.status.failed': 'Falhou',
  'rungraph.status.blocked': 'Bloqueado',
  'rungraph.status.skipped': 'Ignorado',
  'rungraph.outputs.title': 'Saída',
  'rungraph.outputs.empty': 'Ainda sem saída',
  'rungraph.openSession': 'Abrir sessão',
  'rungraph.issue.emptyGraph': 'O grafo precisa de pelo menos um nó de execução.',
  'rungraph.issue.duplicateTitle': 'O título "{title}" é usado mais de uma vez.',
  'rungraph.issue.nodeMissingInstances': '"{title}" precisa de pelo menos um modelo.',
  'rungraph.issue.nodeTooManyInstances': '"{title}" excede o máximo de 5 modelos.',
  'rungraph.issue.instanceMissingModel': '"{title}" tem uma entrada de modelo sem provedor ou modelo.',
  'rungraph.issue.edgeDanglingNode': 'Uma conexão referencia um nó inexistente.',
  'rungraph.issue.edgeDanglingInstance': 'Uma conexão referencia uma saída de modelo inexistente.',
  'rungraph.issue.edgeDuplicate': 'Já existe uma conexão duplicada entre a mesma saída e nó.',
  'rungraph.issue.edgeSelf': 'Um nó não pode ser a própria entrada.',
  'rungraph.issue.edgeCycle': '"{title}" faz parte de um ciclo de dependências.',
  'rungraph.issue.templateSyntax': '"{title}" tem uma expressão de template inválida.',
  'rungraph.issue.templateNoInputs': '"{title}" faz referência a "{name}", mas nada está conectado a ela.',
  'rungraph.issue.templateInputRange': '"{title}" faz referência a "{name}[N]", mas a entrada tem menos valores conectados.',
  'rungraph.issue.bindingDangling': 'Um nó referencia um worktree inexistente.',
  'rungraph.issue.worktreeMissingPath': 'O worktree "{title}" precisa de um caminho.',
  'rungraph.issue.worktreeMissingName': 'O worktree "{title}" precisa de um nome.',
  'rungraph.issue.worktreeDuplicateTitle': 'O título do worktree "{title}" é usado mais de uma vez.',
  'rungraph.issue.instancePoolDangling': '"{title}" referencia um worktree inexistente.',
  'rungraph.issue.sharedWorktree': '{count} execuções compartilham o worktree "{title}" e serão executadas ao mesmo tempo.',
  'rungraph.issue.worktreeOrphan': 'O worktree "{title}" não é usado por nenhuma execução.',
  'rungraph.editor.nodeInputs': 'Entradas',
  'rungraph.editor.addInput': 'Adicionar entrada',
  'rungraph.editor.inputName': 'Nome da entrada',
  'rungraph.editor.inputNamePlaceholder': 'ex.: topico',
  'rungraph.editor.removeInput': 'Remover entrada',
  'rungraph.editor.noInputs': 'Ainda não há entradas nomeadas. Adicione uma, conecte saídas a ela e faça referência no prompt.',
  'rungraph.editor.insertVariable': 'Inserir variável',
  'rungraph.issue.edgeInputTargetInvalid': 'Uma conexão para "{title}" não aponta para uma entrada existente.',
  'rungraph.issue.inputMissingName': 'O nó "{title}" tem uma entrada sem nome.',
  'rungraph.issue.inputDuplicateName': 'O nó "{title}" usa o nome de entrada "{name}" mais de uma vez.',
  'rungraph.issue.inputInvalidName': 'O nó "{title}" tem um nome de entrada inválido "{name}".',
  'rungraph.issue.templateUnknownInput': '"{title}" faz referência a "{name}", mas não tem nenhuma entrada com esse nome.',
  'rungraph.toolbar.addForm': 'Adicionar formulário',
  'rungraph.form.badge': 'Formulário',
  'rungraph.form.noFields': 'Ainda não há campos',
  'rungraph.form.description': 'Os campos do formulário viram saídas que você pode conectar aos prompts de execução. Cada formulário aparece durante a execução do grafo, bem antes de uma execução precisar dele.',
  'rungraph.scope.location': 'Local de salvamento',
  'rungraph.scope.project': 'Projeto',
  'rungraph.scope.global': 'Global',
  'rungraph.form.fields': 'Campos',
  'rungraph.form.addField': 'Adicionar campo',
  'rungraph.form.fieldTitle': 'Título do campo',
  'rungraph.form.fieldTitlePlaceholder': 'Para que serve este campo?',
  'rungraph.form.fieldType': 'Tipo',
  'rungraph.form.fieldType.text': 'Texto',
  'rungraph.form.fieldType.textarea': 'Parágrafo',
  'rungraph.form.fieldType.number': 'Número',
  'rungraph.form.fieldType.date': 'Data',
  'rungraph.form.fieldType.time': 'Hora',
  'rungraph.form.fieldType.select': 'Lista suspensa',
  'rungraph.form.fieldType.slider': 'Controle deslizante',
  'rungraph.form.fieldType.checkbox': 'Caixa de seleção',
  'rungraph.form.removeField': 'Remover campo',
  'rungraph.form.fieldPlaceholder': 'Texto de exemplo',
  'rungraph.form.fieldOptions': 'Opções (uma por linha)',
  'rungraph.form.fieldOptionsPlaceholder': 'Opção A\nOpção B',
  'rungraph.form.fieldMin': 'Mín',
  'rungraph.form.fieldMax': 'Máx',
  'rungraph.form.fieldStep': 'Passo',
  'rungraph.form.fieldRequired': 'Obrigatório',
  'rungraph.form.fieldDefault': 'Valor padrão',
  'rungraph.form.fieldDefaultNone': 'Nenhum',
  'rungraph.form.defaults': 'Valores padrão injetados',
  'rungraph.form.dialog.description': 'Preencha este formulário para continuar a execução do grafo.',
  'rungraph.form.dialog.submit': 'Enviar',
  'rungraph.form.dialog.cancel': 'Cancelar',
  'rungraph.form.dialog.enabled': 'Ativado',
  'rungraph.form.dialog.disabled': 'Desativado',
  'rungraph.issue.edgeSourcePortInvalid': 'Uma conexão de "{title}" não aponta para uma saída existente.',
  'rungraph.issue.edgeFormTargetInvalid': 'Uma conexão para "{title}" não aponta para um campo de formulário existente.',
  'rungraph.issue.formMissingFields': 'O formulário "{title}" precisa de pelo menos um campo.',
  'rungraph.issue.formFieldMissingTitle': 'O formulário "{title}" tem um campo sem título.',
  'rungraph.issue.formFieldDuplicateTitle': 'O formulário "{title}" usa o título de campo "{field}" mais de uma vez.',
  'rungraph.issue.formFieldSelectOptions': 'O formulário "{title}" tem um campo de lista suspensa sem opções.',
  'rungraph.issue.formFieldSliderBounds': 'O formulário "{title}" tem um controle deslizante sem valor mínimo e máximo.',
  'rungraph.issue.formFieldRange': 'O formulário "{title}" tem um campo cujo mínimo é maior que o máximo.',
  'rungraph.issue.formUnused': 'O formulário "{title}" não está conectado a nenhuma execução e não será exibido.',
};
