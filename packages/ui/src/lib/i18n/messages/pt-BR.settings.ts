...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.field.messageTimestampFormat": "Hora da mensagem",
  "settings.openchamber.visual.field.selectMessageTimestampFormatAria": "Selecionar formato de hora da mensagem",
  "settings.openchamber.visual.option.messageTimestampFormat.hidden.label": "Oculto",
  "settings.openchamber.visual.option.messageTimestampFormat.hidden.description": "Não mostrar data/hora nas mensagens.",
  "settings.openchamber.visual.option.messageTimestampFormat.relative.label": "Relativo",
  "settings.openchamber.visual.option.messageTimestampFormat.relative.description": "Mostrar tempo decorrido, ex. «há 2 h 15 min».",
  "settings.openchamber.visual.option.messageTimestampFormat.absolute.label": "Absoluto",
  "settings.openchamber.visual.option.messageTimestampFormat.absolute.description": "Mostrar o carimbo de data/hora exato.",
  "settings.openchamber.visual.option.messageTimestampFormat.hybrid.label": "Híbrido",
  "settings.openchamber.visual.option.messageTimestampFormat.hybrid.description": "Relativo até a mensagem atingir a idade limite, depois absoluto.",
  "settings.openchamber.visual.field.messageTimestampHybridThreshold": "Duração antes de alternar para absoluto (ex. 1d 2h 30m)",
  "settings.openchamber.visual.field.messageTimestampHybridThresholdDays": "dias",
