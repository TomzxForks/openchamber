...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.openchamber.visual.field.messageTimestampFormat': 'Czas wiadomości',
  'settings.openchamber.visual.field.selectMessageTimestampFormatAria': 'Wybierz format czasu wiadomości',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.label': 'Ukryty',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.description': 'Nie pokazuj daty/godziny przy wiadomościach.',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.label': 'Względny',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.description': 'Pokazuj czas, który upłynął, np. „2 godz. 15 min temu”.',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.label': 'Bezwzględny',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.description': 'Pokazuj dokładny znacznik czasu.',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.label': 'Hybrydowy',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.description': 'Względny do osiągnięcia progowego wieku wiadomości, potem bezwzględny.',
  'settings.openchamber.visual.field.messageTimestampHybridThreshold': 'Czas przed przełączeniem na bezwzględny (np. 1d 2h 30m)',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdDays': 'dni',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdHours': 'godz.',
