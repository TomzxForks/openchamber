...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.messageTimestampFormat': '消息时间',
  'settings.openchamber.visual.field.selectMessageTimestampFormatAria': '选择消息时间格式',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.label': '隐藏',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.description': '不在消息上显示日期/时间。',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.label': '相对',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.description': '显示已用时间，例如“2小时2分钟前”。',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.label': '绝对',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.description': '显示确切的时间戳。',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.label': '混合',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.description': '消息达到阈值年龄之前显示相对时间，之后显示绝对时间。',
  'settings.openchamber.visual.field.messageTimestampHybridThreshold': '切换为绝对显示之前的时长（例如 1d 2h 30m）',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdDays': '天',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdHours': '小时',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdMinutes': '分钟',
