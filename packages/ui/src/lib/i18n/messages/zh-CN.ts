...
export const dict: Record<I18nKey, string> = {
  ...
  'commandPalette.item.openGraphs': '打开图表',
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': '图表',
  'rungraph.toolbar.new': '新建',
  'rungraph.toolbar.save': '保存',
  'rungraph.toolbar.delete': '删除',
  'rungraph.toolbar.run': '运行',
  'rungraph.toolbar.stop': '停止',
  'rungraph.toolbar.addRun': '添加运行节点',
  'rungraph.toolbar.addWorktree': '添加工作树',
  'rungraph.toolbar.validation': '校验',
  'rungraph.toolbar.validationOk': '未发现问题',
  'rungraph.toolbar.saved': '图表已保存',
  'rungraph.toolbar.saveFailed': '保存图表失败',
  'rungraph.editor.nodeTitle': '节点标题',
  'rungraph.editor.agent': '智能体',
  'rungraph.editor.models': '模型',
  'rungraph.editor.prompt': '提示词模板',
  'rungraph.editor.promptHint': '使用 {{name}} 这类变量引用已连接的输入。',
  'rungraph.editor.worktree': '工作树',
  'rungraph.editor.nodeWorktree': '节点工作树',
  'rungraph.editor.nodeWorktreeNone': '项目根目录',
  'rungraph.editor.selectNodeHint': '选择一个运行节点或工作树节点进行编辑。',
  'rungraph.empty.title': '开始构建图表',
  'rungraph.sessions.title': '会话',
  'rungraph.editor.inputs': '输入',
  'rungraph.empty.description': '添加一个包含智能体提示词和模型的运行节点，然后将输出连接到其他运行。工作树节点让智能体在共享或新建的 git 工作树中运行。',
  'rungraph.editor.worktreeInherit': '节点默认',
  'rungraph.editor.worktreeRoot': '项目根目录',
  'rungraph.editor.worktreePool': '共享：{name}',
  'rungraph.editor.worktreeDedicated': '新建专用工作树',
  'rungraph.worktree.kindExisting': '现有',
  'rungraph.worktree.kindNew': '新建',
  'rungraph.worktree.path': '路径',
  'rungraph.worktree.name': '名称',
  'rungraph.worktree.baseBranch': '基准分支',
  'rungraph.worktree.setupCommands': '设置命令',
  'rungraph.status.pending': '等待中',
  'rungraph.status.starting': '启动中',
  'rungraph.status.running': '运行中',
  'rungraph.status.done': '已完成',
  'rungraph.status.failed': '已失败',
  'rungraph.status.blocked': '已阻塞',
  'rungraph.status.skipped': '已跳过',
  'rungraph.outputs.title': '输出',
  'rungraph.outputs.empty': '暂无输出',
  'rungraph.openSession': '打开会话',
  'rungraph.issue.emptyGraph': '图表至少需要一个运行节点。',
  'rungraph.issue.duplicateTitle': '标题“{title}”被多次使用。',
  'rungraph.issue.nodeMissingInstances': '“{title}”至少需要一个模型。',
  'rungraph.issue.nodeTooManyInstances': '“{title}”超过了 5 个模型的上限。',
  'rungraph.issue.instanceMissingModel': '“{title}”存在缺少提供商或模型的模型条目。',
  'rungraph.issue.edgeDanglingNode': '某个连接引用了不存在的节点。',
  'rungraph.issue.edgeDanglingInstance': '某个连接引用了不存在的模型输出。',
  'rungraph.issue.edgeDuplicate': '相同的输出与节点之间已存在重复连接。',
  'rungraph.issue.edgeSelf': '节点不能作为自己的输入。',
  'rungraph.issue.edgeCycle': '“{title}”位于依赖循环中。',
  'rungraph.issue.templateSyntax': '“{title}”包含无效的模板表达式。',
  'rungraph.issue.templateNoInputs': '“{title}”引用了“{name}”，但没有东西连接到它。',
  'rungraph.issue.templateInputRange': '“{title}”引用了“{name}[N]”，但该输入连接的值不够。',
  'rungraph.issue.bindingDangling': '某个节点引用了不存在的工作树。',
  'rungraph.issue.worktreeMissingPath': '工作树“{title}”需要路径。',
  'rungraph.issue.worktreeMissingName': '工作树“{title}”需要名称。',
  'rungraph.issue.worktreeDuplicateTitle': '工作树标题“{title}”被多次使用。',
  'rungraph.issue.instancePoolDangling': '“{title}”引用了不存在的工作树。',
  'rungraph.issue.sharedWorktree': '{count} 个运行共享工作树“{title}”，将并发执行。',
  'rungraph.issue.worktreeOrphan': '工作树“{title}”没有被任何运行使用。',
  'rungraph.editor.nodeInputs': '输入',
  'rungraph.editor.addInput': '添加输入',
  'rungraph.editor.inputName': '输入名称',
  'rungraph.editor.inputNamePlaceholder': '例如：topic',
  'rungraph.editor.removeInput': '删除输入',
  'rungraph.editor.noInputs': '尚无命名输入。添加一个，把输出连接到它，然后在提示词中引用。',
  'rungraph.editor.insertVariable': '插入变量',
  'rungraph.issue.edgeInputTargetInvalid': '连向“{title}”的连接没有指向现有输入。',
  'rungraph.issue.inputMissingName': '节点“{title}”有输入缺少名称。',
  'rungraph.issue.inputDuplicateName': '节点“{title}”多次使用输入名称“{name}”。',
  'rungraph.issue.inputInvalidName': '节点“{title}”有无效的输入名称“{name}”。',
  'rungraph.issue.templateUnknownInput': '“{title}”引用了“{name}”，但没有该名称的输入。',
  'rungraph.toolbar.addForm': '添加表单',
  'rungraph.form.badge': '表单',
  'rungraph.form.noFields': '尚无字段',
  'rungraph.form.description': '表单字段会成为输出，可以连接到运行提示词中。每个表单都会在图执行期间、运行真正需要它时才显示。',
  'rungraph.scope.location': '保存位置',
  'rungraph.scope.project': '项目',
  'rungraph.scope.global': '全局',
  'rungraph.form.fields': '字段',
  'rungraph.form.addField': '添加字段',
  'rungraph.form.fieldTitle': '字段标题',
  'rungraph.form.fieldTitlePlaceholder': '这个字段的用途是什么？',
  'rungraph.form.fieldType': '类型',
  'rungraph.form.fieldType.text': '文本',
  'rungraph.form.fieldType.textarea': '段落',
  'rungraph.form.fieldType.number': '数字',
  'rungraph.form.fieldType.date': '日期',
  'rungraph.form.fieldType.time': '时间',
  'rungraph.form.fieldType.select': '下拉列表',
  'rungraph.form.fieldType.slider': '滑块',
  'rungraph.form.fieldType.checkbox': '复选框',
  'rungraph.form.removeField': '删除字段',
  'rungraph.form.fieldPlaceholder': '占位符',
  'rungraph.form.fieldOptions': '选项（每行一个）',
  'rungraph.form.fieldOptionsPlaceholder': '选项 A\n选项 B',
  'rungraph.form.fieldMin': '最小值',
  'rungraph.form.fieldMax': '最大值',
  'rungraph.form.fieldStep': '步长',
  'rungraph.form.fieldRequired': '必填',
  'rungraph.form.fieldDefault': '默认值',
  'rungraph.form.fieldDefaultNone': '无',
  'rungraph.form.defaults': '注入的默认值',
  'rungraph.form.dialog.description': '请填写此表单以继续图的执行。',
  'rungraph.form.dialog.submit': '提交',
  'rungraph.form.dialog.cancel': '取消',
  'rungraph.form.dialog.enabled': '已启用',
  'rungraph.form.dialog.disabled': '已禁用',
  'rungraph.issue.edgeSourcePortInvalid': '来自“{title}”的连接没有指向现有输出。',
  'rungraph.issue.edgeFormTargetInvalid': '连向“{title}”的连接没有指向现有表单字段。',
  'rungraph.issue.formMissingFields': '表单“{title}”至少需要一个字段。',
  'rungraph.issue.formFieldMissingTitle': '表单“{title}”中有字段缺少标题。',
  'rungraph.issue.formFieldDuplicateTitle': '表单“{title}”多次使用字段标题“{field}”。',
  'rungraph.issue.formFieldSelectOptions': '表单“{title}”中有下拉字段没有选项。',
  'rungraph.issue.formFieldSliderBounds': '表单“{title}”中有滑块字段缺少最小值和最大值。',
  'rungraph.issue.formFieldRange': '表单“{title}”中有字段的最小值大于最大值。',
  'rungraph.issue.formUnused': '表单“{title}”未连接到任何运行，将不会显示。',
};
