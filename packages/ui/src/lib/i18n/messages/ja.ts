...
export const dict: Record<I18nKey, string> = {
  ...
  'commandPalette.item.openGraphs': 'グラフを開く',
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': 'グラフ',
  'rungraph.toolbar.new': '新規',
  'rungraph.toolbar.save': '保存',
  'rungraph.toolbar.delete': '削除',
  'rungraph.toolbar.run': '実行',
  'rungraph.toolbar.stop': '停止',
  'rungraph.toolbar.addRun': '実行ノードを追加',
  'rungraph.toolbar.addWorktree': 'ワークツリーを追加',
  'rungraph.toolbar.validation': '検証',
  'rungraph.toolbar.validationOk': '問題は見つかりませんでした',
  'rungraph.toolbar.saved': 'グラフを保存しました',
  'rungraph.toolbar.saveFailed': 'グラフを保存できませんでした',
  'rungraph.editor.nodeTitle': 'ノードタイトル',
  'rungraph.editor.agent': 'エージェント',
  'rungraph.editor.models': 'モデル',
  'rungraph.editor.prompt': 'プロンプトテンプレート',
  'rungraph.editor.promptHint': '{{name}} のような変数で接続された入力を取り込みます。',
  'rungraph.editor.worktree': 'ワークツリー',
  'rungraph.editor.nodeWorktree': 'ノードのワークツリー',
  'rungraph.editor.nodeWorktreeNone': 'プロジェクトルート',
  'rungraph.editor.selectNodeHint': '編集する実行ノードまたはワークツリーノードを選択してください。',
  'rungraph.empty.title': 'グラフの構築を始めましょう',
  'rungraph.sessions.title': 'セッション',
  'rungraph.editor.inputs': '入力',
  'rungraph.empty.description': 'エージェントのプロンプトとモデルを含む実行ノードを追加し、出力を他の実行に接続しましょう。ワークツリーノードは共有または新規の git ワークツリーでエージェントを実行します。',
  'rungraph.editor.worktreeInherit': 'ノードの既定',
  'rungraph.editor.worktreeRoot': 'プロジェクトルート',
  'rungraph.editor.worktreePool': '共有: {name}',
  'rungraph.editor.worktreeDedicated': '専用ワークツリーを新規作成',
  'rungraph.worktree.kindExisting': '既存',
  'rungraph.worktree.kindNew': '新規',
  'rungraph.worktree.path': 'パス',
  'rungraph.worktree.name': '名前',
  'rungraph.worktree.baseBranch': 'ベースブランチ',
  'rungraph.worktree.setupCommands': 'セットアップコマンド',
  'rungraph.status.pending': '待機中',
  'rungraph.status.starting': '開始中',
  'rungraph.status.running': '実行中',
  'rungraph.status.done': '完了',
  'rungraph.status.failed': '失敗',
  'rungraph.status.blocked': 'ブロック',
  'rungraph.status.skipped': 'スキップ',
  'rungraph.outputs.title': '出力',
  'rungraph.outputs.empty': '出力はまだありません',
  'rungraph.openSession': 'セッションを開く',
  'rungraph.issue.emptyGraph': 'グラフには少なくとも 1 つの実行ノードが必要です。',
  'rungraph.issue.duplicateTitle': 'タイトル「{title}」は複数回使用されています。',
  'rungraph.issue.nodeMissingInstances': '「{title}」には少なくとも 1 つのモデルが必要です。',
  'rungraph.issue.nodeTooManyInstances': '「{title}」はモデル数の上限 5 を超えています。',
  'rungraph.issue.instanceMissingModel': '「{title}」にプロバイダまたはモデルのないモデルエントリがあります。',
  'rungraph.issue.edgeDanglingNode': 'ある接続が存在しないノードを参照しています。',
  'rungraph.issue.edgeDanglingInstance': 'ある接続が存在しないモデル出力を参照しています。',
  'rungraph.issue.edgeDuplicate': '同じ出力とノードの間に重複した接続が存在します。',
  'rungraph.issue.edgeSelf': 'ノードは自分自身への入力になれません。',
  'rungraph.issue.edgeCycle': '「{title}」は依存関係の循環の一部です。',
  'rungraph.issue.templateSyntax': '「{title}」に無効なテンプレート式があります。',
  'rungraph.issue.templateNoInputs': '「{title}」は「{name}」を参照していますが、何も接続されていません。',
  'rungraph.issue.templateInputRange': '「{title}」は「{name}[N]」を参照していますが、接続された値が足りません。',
  'rungraph.issue.bindingDangling': 'あるノードが存在しないワークツリーを参照しています。',
  'rungraph.issue.worktreeMissingPath': 'ワークツリー「{title}」にはパスが必要です。',
  'rungraph.issue.worktreeMissingName': 'ワークツリー「{title}」には名前が必要です。',
  'rungraph.issue.worktreeDuplicateTitle': 'ワークツリーのタイトル「{title}」は複数回使用されています。',
  'rungraph.issue.instancePoolDangling': '「{title}」が存在しないワークツリーを参照しています。',
  'rungraph.issue.sharedWorktree': '{count} 個の実行がワークツリー「{title}」を共有しており、同時に実行されます。',
  'rungraph.issue.worktreeOrphan': 'ワークツリー「{title}」はどの実行からも使用されていません。',
  'rungraph.editor.nodeInputs': '入力',
  'rungraph.editor.addInput': '入力を追加',
  'rungraph.editor.inputName': '入力名',
  'rungraph.editor.inputNamePlaceholder': '例: topic',
  'rungraph.editor.removeInput': '入力を削除',
  'rungraph.editor.noInputs': '名前付き入力はまだありません。追加して出力を接続し、プロンプトで参照してください。',
  'rungraph.editor.insertVariable': '変数を挿入',
  'rungraph.issue.edgeInputTargetInvalid': '「{title}」への接続が既存の入力を指していません。',
  'rungraph.issue.inputMissingName': 'ノード「{title}」に名前のない入力があります。',
  'rungraph.issue.inputDuplicateName': 'ノード「{title}」は入力名「{name}」を複数回使用しています。',
  'rungraph.issue.inputInvalidName': 'ノード「{title}」に無効な入力名「{name}」があります。',
  'rungraph.issue.templateUnknownInput': '「{title}」は「{name}」を参照していますが、その名前の入力はありません。',
  'rungraph.toolbar.addForm': 'フォームを追加',
  'rungraph.form.badge': 'フォーム',
  'rungraph.form.noFields': 'フィールドはまだありません',
  'rungraph.form.description': 'フォームのフィールドは出力として扱われ、実行ノードのプロンプトに接続できます。各フォームはグラフの実行中、実際に必要になる直前に表示されます。',
  'rungraph.scope.location': '保存先',
  'rungraph.scope.project': 'プロジェクト',
  'rungraph.scope.global': 'グローバル',
  'rungraph.form.fields': 'フィールド',
  'rungraph.form.addField': 'フィールドを追加',
  'rungraph.form.fieldTitle': 'フィールドのタイトル',
  'rungraph.form.fieldTitlePlaceholder': 'このフィールドの目的は何ですか？',
  'rungraph.form.fieldType': '種類',
  'rungraph.form.fieldType.text': 'テキスト',
  'rungraph.form.fieldType.textarea': '段落',
  'rungraph.form.fieldType.number': '数値',
  'rungraph.form.fieldType.date': '日付',
  'rungraph.form.fieldType.time': '時刻',
  'rungraph.form.fieldType.select': 'ドロップダウン',
  'rungraph.form.fieldType.slider': 'スライダー',
  'rungraph.form.fieldType.checkbox': 'チェックボックス',
  'rungraph.form.removeField': 'フィールドを削除',
  'rungraph.form.fieldPlaceholder': 'プレースホルダー',
  'rungraph.form.fieldOptions': '選択肢（1 行に 1 つ）',
  'rungraph.form.fieldOptionsPlaceholder': '選択肢 A\n選択肢 B',
  'rungraph.form.fieldMin': '最小',
  'rungraph.form.fieldMax': '最大',
  'rungraph.form.fieldStep': '刻み',
  'rungraph.form.fieldRequired': '必須',
  'rungraph.form.fieldDefault': 'デフォルト値',
  'rungraph.form.fieldDefaultNone': 'なし',
  'rungraph.form.defaults': '注入されたデフォルト値',
  'rungraph.form.dialog.description': 'グラフの実行を続けるには、このフォームに入力してください。',
  'rungraph.form.dialog.submit': '送信',
  'rungraph.form.dialog.cancel': 'キャンセル',
  'rungraph.form.dialog.enabled': 'オン',
  'rungraph.form.dialog.disabled': 'オフ',
  'rungraph.issue.edgeSourcePortInvalid': '「{title}」からの接続が既存の出力を指していません。',
  'rungraph.issue.edgeFormTargetInvalid': '「{title}」への接続が既存のフォームフィールドを指していません。',
  'rungraph.issue.formMissingFields': 'フォーム「{title}」には少なくとも 1 つのフィールドが必要です。',
  'rungraph.issue.formFieldMissingTitle': 'フォーム「{title}」にタイトルのないフィールドがあります。',
  'rungraph.issue.formFieldDuplicateTitle': 'フォーム「{title}」はフィールドタイトル「{field}」を複数回使用しています。',
  'rungraph.issue.formFieldSelectOptions': 'フォーム「{title}」に選択肢のないドロップダウンフィールドがあります。',
  'rungraph.issue.formFieldSliderBounds': 'フォーム「{title}」に最小値と最大値のないスライダーフィールドがあります。',
  'rungraph.issue.formFieldRange': 'フォーム「{title}」に最小値が最大値を超えているフィールドがあります。',
  'rungraph.issue.formUnused': 'フォーム「{title}」はどの実行にも接続されていないため、表示されません。',
};
