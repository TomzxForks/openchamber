...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.messageTimestampFormat': '메시지 시간',
  'settings.openchamber.visual.field.selectMessageTimestampFormatAria': '메시지 시간 형식 선택',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.label': '숨김',
  'settings.openchamber.visual.option.messageTimestampFormat.hidden.description': '메시지에 날짜/시간을 표시하지 않습니다.',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.label': '상대',
  'settings.openchamber.visual.option.messageTimestampFormat.relative.description': '경과 시간을 표시합니다(예: “2시간 15분 전”).',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.label': '절대',
  'settings.openchamber.visual.option.messageTimestampFormat.absolute.description': '정확한 타임스탬프를 표시합니다.',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.label': '하이브리드',
  'settings.openchamber.visual.option.messageTimestampFormat.hybrid.description': '메시지가 임계 연령에 도달할 때까지는 상대, 이후에는 절대로 표시합니다.',
  'settings.openchamber.visual.field.messageTimestampHybridThreshold': '절대 표시로 전환되기까지의 기간(예: 1d 2h 30m)',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdDays': '일',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdHours': '시간',
  'settings.openchamber.visual.field.messageTimestampHybridThresholdMinutes': '분',
