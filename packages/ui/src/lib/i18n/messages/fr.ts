...
export const dict = {
  ...
  'commandPalette.item.openGraphs': 'Ouvrir les graphes',
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': 'Graphes',
  'rungraph.toolbar.new': 'Nouveau',
  'rungraph.toolbar.save': 'Enregistrer',
  'rungraph.toolbar.delete': 'Supprimer',
  'rungraph.toolbar.run': 'Exécuter',
  'rungraph.toolbar.stop': 'Arrêter',
  'rungraph.toolbar.addRun': 'Ajouter une exécution',
  'rungraph.toolbar.addWorktree': 'Ajouter un worktree',
  'rungraph.toolbar.validation': 'Validation',
  'rungraph.toolbar.validationOk': 'Aucun problème détecté',
  'rungraph.toolbar.saved': 'Graphe enregistré',
  'rungraph.toolbar.saveFailed': 'Échec de l’enregistrement du graphe',
  'rungraph.editor.nodeTitle': 'Titre du nœud',
  'rungraph.editor.agent': 'Agent',
  'rungraph.editor.models': 'Modèles',
  'rungraph.editor.prompt': 'Modèle de prompt',
  'rungraph.editor.promptHint': 'Utilisez des variables comme {{name}} pour inclure les entrées connectées.',
  'rungraph.editor.worktree': 'Worktree',
  'rungraph.editor.nodeWorktree': 'Worktree du nœud',
  'rungraph.editor.nodeWorktreeNone': 'Racine du projet',
  'rungraph.editor.selectNodeHint': 'Sélectionnez un nœud d’exécution ou un worktree pour le modifier.',
  'rungraph.empty.title': 'Commencez à construire votre graphe',
  'rungraph.sessions.title': 'Sessions',
  'rungraph.editor.inputs': 'Entrées',
  'rungraph.empty.description': 'Ajoutez un nœud d’exécution avec un prompt d’agent et des modèles, puis connectez les sorties vers d’autres exécutions. Les nœuds worktree exécutent les agents dans un worktree git partagé ou nouveau.',
  'rungraph.editor.worktreeInherit': 'Valeur par défaut du nœud',
  'rungraph.editor.worktreeRoot': 'Racine du projet',
  'rungraph.editor.worktreePool': 'Partagé : {name}',
  'rungraph.editor.worktreeDedicated': 'Nouveau worktree dédié',
  'rungraph.worktree.kindExisting': 'Existant',
  'rungraph.worktree.kindNew': 'Nouveau',
  'rungraph.worktree.path': 'Chemin',
  'rungraph.worktree.name': 'Nom',
  'rungraph.worktree.baseBranch': 'Branche de base',
  'rungraph.worktree.setupCommands': 'Commandes de configuration',
  'rungraph.status.pending': 'En attente',
  'rungraph.status.starting': 'Démarrage',
  'rungraph.status.running': 'En cours',
  'rungraph.status.done': 'Terminé',
  'rungraph.status.failed': 'Échec',
  'rungraph.status.blocked': 'Bloqué',
  'rungraph.status.skipped': 'Ignoré',
  'rungraph.outputs.title': 'Sortie',
  'rungraph.outputs.empty': 'Aucune sortie pour le moment',
  'rungraph.openSession': 'Ouvrir la session',
  'rungraph.issue.emptyGraph': 'Le graphe nécessite au moins un nœud d’exécution.',
  'rungraph.issue.duplicateTitle': 'Le titre « {title} » est utilisé plus d’une fois.',
  'rungraph.issue.nodeMissingInstances': '« {title} » nécessite au moins un modèle.',
  'rungraph.issue.nodeTooManyInstances': '« {title} » dépasse le maximum de 5 modèles.',
  'rungraph.issue.instanceMissingModel': '« {title} » contient une entrée de modèle sans fournisseur ni modèle.',
  'rungraph.issue.edgeDanglingNode': 'Une connexion référence un nœud manquant.',
  'rungraph.issue.edgeDanglingInstance': 'Une connexion référence une sortie de modèle manquante.',
  'rungraph.issue.edgeDuplicate': 'Une connexion dupliquée existe entre la même sortie et le même nœud.',
  'rungraph.issue.edgeSelf': 'Un nœud ne peut pas être sa propre entrée.',
  'rungraph.issue.edgeCycle': '« {title} » fait partie d’un cycle de dépendances.',
  'rungraph.issue.templateSyntax': '« {title} » contient une expression de modèle non valide.',
  'rungraph.issue.templateNoInputs': '« {title} » fait référence à « {name} », mais rien n’y est connecté.',
  'rungraph.issue.templateInputRange': '« {title} » fait référence à « {name}[N] », mais l’entrée a moins de valeurs connectées.',
  'rungraph.issue.bindingDangling': 'Un nœud référence un worktree manquant.',
  'rungraph.issue.worktreeMissingPath': 'Le worktree « {title} » nécessite un chemin.',
  'rungraph.issue.worktreeMissingName': 'Le worktree « {title} » nécessite un nom.',
  'rungraph.issue.worktreeDuplicateTitle': 'Le titre du worktree « {title} » est utilisé plus d’une fois.',
  'rungraph.issue.instancePoolDangling': '« {title} » référence un worktree manquant.',
  'rungraph.issue.sharedWorktree': '{count} exécutions partagent le worktree « {title} » et s’exécuteront en même temps.',
  'rungraph.issue.worktreeOrphan': 'Le worktree « {title} » n’est utilisé par aucune exécution.',
  'rungraph.editor.nodeInputs': 'Entrées',
  'rungraph.editor.addInput': 'Ajouter une entrée',
  'rungraph.editor.inputName': 'Nom de l’entrée',
  'rungraph.editor.inputNamePlaceholder': 'ex. sujet',
  'rungraph.editor.removeInput': 'Supprimer l’entrée',
  'rungraph.editor.noInputs': 'Aucune entrée nommée pour le moment. Ajoutez-en une, connectez des sorties, puis référencez-la dans l’invite.',
  'rungraph.editor.insertVariable': 'Insérer la variable',
  'rungraph.issue.edgeInputTargetInvalid': 'Une connexion vers « {title} » ne pointe vers aucune entrée existante.',
  'rungraph.issue.inputMissingName': 'Le nœud « {title} » a une entrée sans nom.',
  'rungraph.issue.inputDuplicateName': 'Le nœud « {title} » utilise le nom d’entrée « {name} » plus d’une fois.',
  'rungraph.issue.inputInvalidName': 'Le nœud « {title} » a un nom d’entrée non valide « {name} ».',
  'rungraph.issue.templateUnknownInput': '« {title} » fait référence à « {name} », mais aucune entrée ne porte ce nom.',
  'rungraph.toolbar.addForm': 'Ajouter un formulaire',
  'rungraph.form.badge': 'Formulaire',
  'rungraph.form.noFields': 'Aucun champ pour le moment',
  'rungraph.form.description': 'Les champs du formulaire deviennent des sorties que vous pouvez connecter aux invites des exécutions. Chaque formulaire apparaît pendant l’exécution du graphe, juste avant qu’une exécution en ait besoin.',
  'rungraph.scope.location': 'Emplacement d’enregistrement',
  'rungraph.scope.project': 'Projet',
  'rungraph.scope.global': 'Global',
  'rungraph.form.fields': 'Champs',
  'rungraph.form.addField': 'Ajouter un champ',
  'rungraph.form.fieldTitle': 'Titre du champ',
  'rungraph.form.fieldTitlePlaceholder': 'À quoi sert ce champ ?',
  'rungraph.form.fieldType': 'Type',
  'rungraph.form.fieldType.text': 'Texte',
  'rungraph.form.fieldType.textarea': 'Paragraphe',
  'rungraph.form.fieldType.number': 'Nombre',
  'rungraph.form.fieldType.date': 'Date',
  'rungraph.form.fieldType.time': 'Heure',
  'rungraph.form.fieldType.select': 'Liste déroulante',
  'rungraph.form.fieldType.slider': 'Curseur',
  'rungraph.form.fieldType.checkbox': 'Case à cocher',
  'rungraph.form.removeField': 'Supprimer le champ',
  'rungraph.form.fieldPlaceholder': 'Texte indicatif',
  'rungraph.form.fieldOptions': 'Options (une par ligne)',
  'rungraph.form.fieldOptionsPlaceholder': 'Option A\nOption B',
  'rungraph.form.fieldMin': 'Min',
  'rungraph.form.fieldMax': 'Max',
  'rungraph.form.fieldStep': 'Pas',
  'rungraph.form.fieldRequired': 'Obligatoire',
  'rungraph.form.fieldDefault': 'Valeur par défaut',
  'rungraph.form.fieldDefaultNone': 'Aucune',
  'rungraph.form.defaults': 'Valeurs par défaut injectées',
  'rungraph.form.dialog.description': 'Remplissez ce formulaire pour poursuivre l’exécution du graphe.',
  'rungraph.form.dialog.submit': 'Envoyer',
  'rungraph.form.dialog.cancel': 'Annuler',
  'rungraph.form.dialog.enabled': 'Activé',
  'rungraph.form.dialog.disabled': 'Désactivé',
  'rungraph.issue.edgeSourcePortInvalid': 'Une connexion depuis « {title} » ne pointe vers aucune sortie existante.',
  'rungraph.issue.edgeFormTargetInvalid': 'Une connexion vers « {title} » ne pointe vers aucun champ de formulaire existant.',
  'rungraph.issue.formMissingFields': 'Le formulaire « {title} » a besoin d’au moins un champ.',
  'rungraph.issue.formFieldMissingTitle': 'Le formulaire « {title} » contient un champ sans titre.',
  'rungraph.issue.formFieldDuplicateTitle': 'Le formulaire « {title} » utilise le titre de champ « {field} » plus d’une fois.',
  'rungraph.issue.formFieldSelectOptions': 'Le formulaire « {title} » contient un champ déroulant sans options.',
  'rungraph.issue.formFieldSliderBounds': 'Le formulaire « {title} » contient un curseur sans valeur minimale ni maximale.',
  'rungraph.issue.formFieldRange': 'Le formulaire « {title} » contient un champ dont le minimum dépasse le maximum.',
  'rungraph.issue.formUnused': 'Le formulaire « {title} » n’est connecté à aucune exécution et ne sera pas affiché.',
} as const;
