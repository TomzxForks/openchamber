...
export const dict = {
  ...
  'common.relative.minutesAgoShort2': 'il y a {count} min',
  'common.relative.hoursMinutesAgoShort': 'il y a {hours} h {minutes} min',
  'common.relative.daysHoursMinutesAgoShort': 'il y a {days} j {hours} h {minutes} min',
