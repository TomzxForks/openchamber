...
export const dict: Record<I18nKey, string> = {
  ...
  'commandPalette.item.openGraphs': 'Otwórz grafy',
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': 'Grafy',
  'rungraph.toolbar.new': 'Nowy',
  'rungraph.toolbar.save': 'Zapisz',
  'rungraph.toolbar.delete': 'Usuń',
  'rungraph.toolbar.run': 'Uruchom',
  'rungraph.toolbar.stop': 'Zatrzymaj',
  'rungraph.toolbar.addRun': 'Dodaj uruchomienie',
  'rungraph.toolbar.addWorktree': 'Dodaj drzewo robocze',
  'rungraph.toolbar.validation': 'Walidacja',
  'rungraph.toolbar.validationOk': 'Nie znaleziono problemów',
  'rungraph.toolbar.saved': 'Zapisano graf',
  'rungraph.toolbar.saveFailed': 'Nie udało się zapisać grafu',
  'rungraph.editor.nodeTitle': 'Tytuł węzła',
  'rungraph.editor.agent': 'Agent',
  'rungraph.editor.models': 'Modele',
  'rungraph.editor.prompt': 'Szablon promptu',
  'rungraph.editor.promptHint': 'Użyj zmiennych takich jak {{name}}, aby dołączyć połączone wejścia.',
  'rungraph.editor.worktree': 'Drzewo robocze',
  'rungraph.editor.nodeWorktree': 'Drzewo robocze węzła',
  'rungraph.editor.nodeWorktreeNone': 'Katalog główny projektu',
  'rungraph.editor.selectNodeHint': 'Wybierz węzeł uruchomienia lub drzewo robocze, aby go edytować.',
  'rungraph.empty.title': 'Zacznij tworzyć graf',
  'rungraph.sessions.title': 'Sesje',
  'rungraph.editor.inputs': 'Wejścia',
  'rungraph.empty.description': 'Dodaj węzeł uruchomienia z promptem agenta i modelami, a następnie połącz wyjścia z innymi uruchomieniami. Węzły drzew roboczych uruchamiają agentów we wspólnym lub nowym drzewie roboczym git.',
  'rungraph.editor.worktreeInherit': 'Domyślne węzła',
  'rungraph.editor.worktreeRoot': 'Katalog główny projektu',
  'rungraph.editor.worktreePool': 'Wspólne: {name}',
  'rungraph.editor.worktreeDedicated': 'Nowe dedykowane drzewo robocze',
  'rungraph.worktree.kindExisting': 'Istniejące',
  'rungraph.worktree.kindNew': 'Nowe',
  'rungraph.worktree.path': 'Ścieżka',
  'rungraph.worktree.name': 'Nazwa',
  'rungraph.worktree.baseBranch': 'Gałąź bazowa',
  'rungraph.worktree.setupCommands': 'Polecenia konfiguracji',
  'rungraph.status.pending': 'Oczekuje',
  'rungraph.status.starting': 'Uruchamianie',
  'rungraph.status.running': 'Działa',
  'rungraph.status.done': 'Gotowe',
  'rungraph.status.failed': 'Niepowodzenie',
  'rungraph.status.blocked': 'Zablokowane',
  'rungraph.status.skipped': 'Pominięte',
  'rungraph.outputs.title': 'Wyjście',
  'rungraph.outputs.empty': 'Brak wyjścia',
  'rungraph.openSession': 'Otwórz sesję',
  'rungraph.issue.emptyGraph': 'Graf wymaga co najmniej jednego węzła uruchomienia.',
  'rungraph.issue.duplicateTitle': 'Tytuł "{title}" jest użyty więcej niż raz.',
  'rungraph.issue.nodeMissingInstances': '"{title}" wymaga co najmniej jednego modelu.',
  'rungraph.issue.nodeTooManyInstances': '"{title}" przekracza limit 5 modeli.',
  'rungraph.issue.instanceMissingModel': '"{title}" zawiera wpis modelu bez dostawcy lub modelu.',
  'rungraph.issue.edgeDanglingNode': 'Połączenie odwołuje się do brakującego węzła.',
  'rungraph.issue.edgeDanglingInstance': 'Połączenie odwołuje się do brakującego wyjścia modelu.',
  'rungraph.issue.edgeDuplicate': 'Duplikat połączenia między tym samym wyjściem i węzłem już istnieje.',
  'rungraph.issue.edgeSelf': 'Węzeł nie może być własnym wejściem.',
  'rungraph.issue.edgeCycle': '"{title}" jest częścią cyklu zależności.',
  'rungraph.issue.templateSyntax': '"{title}" zawiera nieprawidłowe wyrażenie szablonu.',
  'rungraph.issue.templateNoInputs': '„{title}” odwołuje się do „{name}”, ale nie ma nic podłączonego.',
  'rungraph.issue.templateInputRange': '„{title}” odwołuje się do „{name}[N]”, ale wejście ma mniej podłączonych wartości.',
  'rungraph.issue.bindingDangling': 'Węzeł odwołuje się do brakującego drzewa roboczego.',
  'rungraph.issue.worktreeMissingPath': 'Drzewo robocze "{title}" wymaga ścieżki.',
  'rungraph.issue.worktreeMissingName': 'Drzewo robocze "{title}" wymaga nazwy.',
  'rungraph.issue.worktreeDuplicateTitle': 'Tytuł drzewa roboczego "{title}" jest użyty więcej niż raz.',
  'rungraph.issue.instancePoolDangling': '"{title}" odwołuje się do brakującego drzewa roboczego.',
  'rungraph.issue.sharedWorktree': '{count} uruchomień współdzieli drzewo robocze "{title}" i będzie wykonywanych równocześnie.',
  'rungraph.issue.worktreeOrphan': 'Drzewo robocze "{title}" nie jest używane przez żadne uruchomienie.',
  'rungraph.editor.nodeInputs': 'Wejścia',
  'rungraph.editor.addInput': 'Dodaj wejście',
  'rungraph.editor.inputName': 'Nazwa wejścia',
  'rungraph.editor.inputNamePlaceholder': 'np. temat',
  'rungraph.editor.removeInput': 'Usuń wejście',
  'rungraph.editor.noInputs': 'Nie ma jeszcze nazwanych wejść. Dodaj jedno, podłącz do niego wyjścia i odwołaj się do niego w prompcie.',
  'rungraph.editor.insertVariable': 'Wstaw zmienną',
  'rungraph.issue.edgeInputTargetInvalid': 'Połączenie do „{title}” nie wskazuje istniejącego wejścia.',
  'rungraph.issue.inputMissingName': 'Węzeł „{title}” ma wejście bez nazwy.',
  'rungraph.issue.inputDuplicateName': 'Węzeł „{title}” używa nazwy wejścia „{name}” więcej niż raz.',
  'rungraph.issue.inputInvalidName': 'Węzeł „{title}” ma nieprawidłową nazwę wejścia „{name}”.',
  'rungraph.issue.templateUnknownInput': '„{title}” odwołuje się do „{name}”, ale nie ma wejścia o tej nazwie.',
  'rungraph.toolbar.addForm': 'Dodaj formularz',
  'rungraph.form.badge': 'Formularz',
  'rungraph.form.noFields': 'Nie ma jeszcze pól',
  'rungraph.form.description': 'Pola formularza stają się wyjściami, które można podłączyć do promptów uruchomień. Każdy formularz pojawia się w trakcie działania grafu, tuż zanim uruchomienie go potrzebuje.',
  'rungraph.scope.location': 'Lokalizacja zapisu',
  'rungraph.scope.project': 'Projekt',
  'rungraph.scope.global': 'Globalny',
  'rungraph.form.fields': 'Pola',
  'rungraph.form.addField': 'Dodaj pole',
  'rungraph.form.fieldTitle': 'Tytuł pola',
  'rungraph.form.fieldTitlePlaceholder': 'Do czego służy to pole?',
  'rungraph.form.fieldType': 'Typ',
  'rungraph.form.fieldType.text': 'Tekst',
  'rungraph.form.fieldType.textarea': 'Akapit',
  'rungraph.form.fieldType.number': 'Liczba',
  'rungraph.form.fieldType.date': 'Data',
  'rungraph.form.fieldType.time': 'Godzina',
  'rungraph.form.fieldType.select': 'Lista rozwijana',
  'rungraph.form.fieldType.slider': 'Suwak',
  'rungraph.form.fieldType.checkbox': 'Pole wyboru',
  'rungraph.form.removeField': 'Usuń pole',
  'rungraph.form.fieldPlaceholder': 'Tekst zastępczy',
  'rungraph.form.fieldOptions': 'Opcje (jedna w wierszu)',
  'rungraph.form.fieldOptionsPlaceholder': 'Opcja A\nOpcja B',
  'rungraph.form.fieldMin': 'Min',
  'rungraph.form.fieldMax': 'Maks',
  'rungraph.form.fieldStep': 'Krok',
  'rungraph.form.fieldRequired': 'Wymagane',
  'rungraph.form.fieldDefault': 'Wartość domyślna',
  'rungraph.form.fieldDefaultNone': 'Brak',
  'rungraph.form.defaults': 'Wstrzyknięte wartości domyślne',
  'rungraph.form.dialog.description': 'Wypełnij ten formularz, aby kontynuować działanie grafu.',
  'rungraph.form.dialog.submit': 'Wyślij',
  'rungraph.form.dialog.cancel': 'Anuluj',
  'rungraph.form.dialog.enabled': 'Włączone',
  'rungraph.form.dialog.disabled': 'Wyłączone',
  'rungraph.issue.edgeSourcePortInvalid': 'Połączenie z „{title}” nie wskazuje istniejącego wyjścia.',
  'rungraph.issue.edgeFormTargetInvalid': 'Połączenie do „{title}” nie wskazuje istniejącego pola formularza.',
  'rungraph.issue.formMissingFields': 'Formularz „{title}” potrzebuje co najmniej jednego pola.',
  'rungraph.issue.formFieldMissingTitle': 'Formularz „{title}” zawiera pole bez tytułu.',
  'rungraph.issue.formFieldDuplicateTitle': 'Formularz „{title}” używa tytułu pola „{field}” więcej niż raz.',
  'rungraph.issue.formFieldSelectOptions': 'Formularz „{title}” zawiera pole listy rozwijanej bez opcji.',
  'rungraph.issue.formFieldSliderBounds': 'Formularz „{title}” zawiera suwak bez wartości minimalnej i maksymalnej.',
  'rungraph.issue.formFieldRange': 'Formularz „{title}” zawiera pole, którego wartość minimalna przekracza maksymalną.',
  'rungraph.issue.formUnused': 'Formularz „{title}” nie jest połączony z żadnym uruchomieniem i nie zostanie wyświetlony.',
} as const;
