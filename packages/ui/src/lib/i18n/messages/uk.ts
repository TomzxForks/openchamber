...
export const dict: Record<I18nKey, string> = {
  ...
  "commandPalette.item.openGraphs": "Відкрити графи",
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': 'Графи',
  'rungraph.toolbar.new': 'Створити',
  'rungraph.toolbar.save': 'Зберегти',
  'rungraph.toolbar.delete': 'Видалити',
  'rungraph.toolbar.run': 'Запустити',
  'rungraph.toolbar.stop': 'Зупинити',
  'rungraph.toolbar.addRun': 'Додати запуск',
  'rungraph.toolbar.addWorktree': 'Додати worktree',
  'rungraph.toolbar.validation': 'Перевірка',
  'rungraph.toolbar.validationOk': 'Проблем не знайдено',
  'rungraph.toolbar.saved': 'Граф збережено',
  'rungraph.toolbar.saveFailed': 'Не вдалося зберегти граф',
  'rungraph.editor.nodeTitle': 'Назва вузла',
  'rungraph.editor.agent': 'Агент',
  'rungraph.editor.models': 'Моделі',
  'rungraph.editor.prompt': 'Шаблон промпта',
  'rungraph.editor.promptHint': 'Використовуйте змінні на кшталт {{name}}, щоб включити підключені входи.',
  'rungraph.editor.worktree': 'Worktree',
  'rungraph.editor.nodeWorktree': 'Worktree вузла',
  'rungraph.editor.nodeWorktreeNone': 'Корінь проєкту',
  'rungraph.editor.selectNodeHint': 'Виберіть вузол запуску або worktree, щоб редагувати його.',
  'rungraph.empty.title': 'Почніть будувати граф',
  'rungraph.sessions.title': 'Сесії',
  'rungraph.editor.inputs': 'Входи',
  'rungraph.empty.description': 'Додайте вузол запуску з промптом агента та моделями, а потім з’єднайте виходи з іншими запусками. Вузли worktree запускають агентів у спільному або новому git-worktree.',
  'rungraph.editor.worktreeInherit': 'Типове для вузла',
  'rungraph.editor.worktreeRoot': 'Корінь проєкту',
  'rungraph.editor.worktreePool': 'Спільний: {name}',
  'rungraph.editor.worktreeDedicated': 'Новий виділений worktree',
  'rungraph.worktree.kindExisting': 'Існуючий',
  'rungraph.worktree.kindNew': 'Новий',
  'rungraph.worktree.path': 'Шлях',
  'rungraph.worktree.name': 'Назва',
  'rungraph.worktree.baseBranch': 'Базова гілка',
  'rungraph.worktree.setupCommands': 'Команди налаштування',
  'rungraph.status.pending': 'Очікує',
  'rungraph.status.starting': 'Запускається',
  'rungraph.status.running': 'Виконується',
  'rungraph.status.done': 'Готово',
  'rungraph.status.failed': 'Помилка',
  'rungraph.status.blocked': 'Заблоковано',
  'rungraph.status.skipped': 'Пропущено',
  'rungraph.outputs.title': 'Вихід',
  'rungraph.outputs.empty': 'Виходу ще немає',
  'rungraph.openSession': 'Відкрити сесію',
  'rungraph.issue.emptyGraph': 'Граф потребує принаймні одного вузла запуску.',
  'rungraph.issue.duplicateTitle': 'Назву "{title}" використано більше одного разу.',
  'rungraph.issue.nodeMissingInstances': '"{title}" потребує принаймні однієї моделі.',
  'rungraph.issue.nodeTooManyInstances': '"{title}" перевищує максимум у 5 моделей.',
  'rungraph.issue.instanceMissingModel': '"{title}" містить запис моделі без постачальника або моделі.',
  'rungraph.issue.edgeDanglingNode': 'З’єднання посилається на відсутній вузол.',
  'rungraph.issue.edgeDanglingInstance': 'З’єднання посилається на відсутній вихід моделі.',
  'rungraph.issue.edgeDuplicate': 'Дублікат з’єднання між тим самим виходом і вузлом уже існує.',
  'rungraph.issue.edgeSelf': 'Вузол не може бути власним входом.',
  'rungraph.issue.edgeCycle': '"{title}" є частиною циклу залежностей.',
  'rungraph.issue.templateSyntax': '"{title}" містить недійсний вираз шаблону.',
  'rungraph.issue.templateNoInputs': '«{title}» посилається на «{name}», але до нього нічого не під’єднано.',
  'rungraph.issue.templateInputRange': '«{title}» посилається на «{name}[N]», але вхід має менше під’єднаних значень.',
  'rungraph.issue.bindingDangling': 'Вузол посилається на відсутній worktree.',
  'rungraph.issue.worktreeMissingPath': 'Worktree "{title}" потребує шляху.',
  'rungraph.issue.worktreeMissingName': 'Worktree "{title}" потребує назву.',
  'rungraph.issue.worktreeDuplicateTitle': 'Назву worktree "{title}" використано більше одного разу.',
  'rungraph.issue.instancePoolDangling': '"{title}" посилається на відсутній worktree.',
  'rungraph.issue.sharedWorktree': '{count} запусків спільно використовують worktree "{title}" і виконуватимуться одночасно.',
  'rungraph.issue.worktreeOrphan': 'Worktree "{title}" не використовується жодним запуском.',
  'rungraph.editor.nodeInputs': 'Входи',
  'rungraph.editor.addInput': 'Додати вхід',
  'rungraph.editor.inputName': 'Назва входу',
  'rungraph.editor.inputNamePlaceholder': 'напр. тема',
  'rungraph.editor.removeInput': 'Видалити вхід',
  'rungraph.editor.noInputs': 'Іменованих входів ще немає. Додайте один, під’єднайте до нього виходи і посилайтеся на нього в промпті.',
  'rungraph.editor.insertVariable': 'Вставити змінну',
  'rungraph.issue.edgeInputTargetInvalid': 'З’єднання з «{title}» не вказує на наявний вхід.',
  'rungraph.issue.inputMissingName': 'Вузол «{title}» містить вхід без назви.',
  'rungraph.issue.inputDuplicateName': 'Вузол «{title}» використовує назву входу «{name}» понад один раз.',
  'rungraph.issue.inputInvalidName': 'Вузол «{title}» має недійсну назву входу «{name}».',
  'rungraph.issue.templateUnknownInput': '«{title}» посилається на «{name}», але не має входу з такою назвою.',
  'rungraph.toolbar.addForm': 'Додати форму',
  'rungraph.form.badge': 'Форма',
  'rungraph.form.noFields': 'Ще немає полів',
  'rungraph.form.description': 'Поля форми стають виходами, які можна з’єднати з промптами запусків. Кожна форма з’являється під час виконання графа, безпосередньо перед тим, як запуск її потребуватиме.',
  'rungraph.scope.location': 'Місце збереження',
  'rungraph.scope.project': 'Проєкт',
  'rungraph.scope.global': 'Глобальний',
  'rungraph.form.fields': 'Поля',
  'rungraph.form.addField': 'Додати поле',
  'rungraph.form.fieldTitle': 'Назва поля',
  'rungraph.form.fieldTitlePlaceholder': 'Для чого це поле?',
  'rungraph.form.fieldType': 'Тип',
  'rungraph.form.fieldType.text': 'Текст',
  'rungraph.form.fieldType.textarea': 'Абзац',
  'rungraph.form.fieldType.number': 'Число',
  'rungraph.form.fieldType.date': 'Дата',
  'rungraph.form.fieldType.time': 'Час',
  'rungraph.form.fieldType.select': 'Випадний список',
  'rungraph.form.fieldType.slider': 'Повзунок',
  'rungraph.form.fieldType.checkbox': 'Прапорець',
  'rungraph.form.removeField': 'Видалити поле',
  'rungraph.form.fieldPlaceholder': 'Заповнювач',
  'rungraph.form.fieldOptions': 'Варіанти (по одному на рядок)',
  'rungraph.form.fieldOptionsPlaceholder': 'Варіант A\nВаріант B',
  'rungraph.form.fieldMin': 'Мін',
  'rungraph.form.fieldMax': 'Макс',
  'rungraph.form.fieldStep': 'Крок',
  'rungraph.form.fieldRequired': "Обов'язкове",
  'rungraph.form.fieldDefault': 'Значення за замовчуванням',
  'rungraph.form.fieldDefaultNone': 'Немає',
  'rungraph.form.defaults': 'Підставлені значення за замовчуванням',
  'rungraph.form.dialog.description': 'Заповніть цю форму, щоб продовжити виконання графа.',
  'rungraph.form.dialog.submit': 'Надіслати',
  'rungraph.form.dialog.cancel': 'Скасувати',
  'rungraph.form.dialog.enabled': 'Увімкнено',
  'rungraph.form.dialog.disabled': 'Вимкнено',
  'rungraph.issue.edgeSourcePortInvalid': 'З’єднання з «{title}» не вказує на наявний вихід.',
  'rungraph.issue.edgeFormTargetInvalid': 'З’єднання з «{title}» не вказує на наявне поле форми.',
  'rungraph.issue.formMissingFields': 'Формі «{title}» потрібне щонайменше одне поле.',
  'rungraph.issue.formFieldMissingTitle': 'Форма «{title}» містить поле без назви.',
  'rungraph.issue.formFieldDuplicateTitle': 'Форма «{title}» використовує назву поля «{field}» понад один раз.',
  'rungraph.issue.formFieldSelectOptions': 'Форма «{title}» містить випадний список без варіантів.',
  'rungraph.issue.formFieldSliderBounds': 'Форма «{title}» містить повзунок без мінімального та максимального значень.',
  'rungraph.issue.formFieldRange': 'Форма «{title}» містить поле, чиє мінімальне значення перевищує максимальне.',
  'rungraph.issue.formUnused': 'Форма «{title}» не з’єднана з жодним запуском і не буде показана.',
};
