...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.visual.field.messageTimestampFormat": "Hora del mensaje",
  "settings.openchamber.visual.field.selectMessageTimestampFormatAria": "Seleccionar formato de hora del mensaje",
  "settings.openchamber.visual.option.messageTimestampFormat.hidden.label": "Oculto",
  "settings.openchamber.visual.option.messageTimestampFormat.hidden.description": "No mostrar fecha/hora en los mensajes.",
  "settings.openchamber.visual.option.messageTimestampFormat.relative.label": "Relativo",
  "settings.openchamber.visual.option.messageTimestampFormat.relative.description": "Mostrar tiempo transcurrido, p. ej. «hace 2 h 15 min».",
  "settings.openchamber.visual.option.messageTimestampFormat.absolute.label": "Absoluto",
  "settings.openchamber.visual.option.messageTimestampFormat.absolute.description": "Mostrar la marca de tiempo exacta.",
  "settings.openchamber.visual.option.messageTimestampFormat.hybrid.label": "Híbrido",
  "settings.openchamber.visual.option.messageTimestampFormat.hybrid.description": "Relativo hasta que el mensaje alcanza la edad umbral, luego absoluto.",
  "settings.openchamber.visual.field.messageTimestampHybridThreshold": "Duración antes de cambiar a absoluto (p. ej. 1d 2h 30m)",
  "settings.openchamber.visual.field.messageTimestampHybridThresholdDays": "días",
  "settings.openchamber.visual.field.messageTimestampHybridThresholdHours": "horas",
