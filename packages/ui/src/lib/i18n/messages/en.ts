...
export const dict = {
  ...
  'commandPalette.item.openGraphs': 'Open graphs',
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': 'Graphs',
  'rungraph.toolbar.new': 'New',
  'rungraph.toolbar.save': 'Save',
  'rungraph.toolbar.delete': 'Delete',
  'rungraph.toolbar.run': 'Run',
  'rungraph.toolbar.stop': 'Stop',
  'rungraph.toolbar.addRun': 'Add run',
  'rungraph.toolbar.addWorktree': 'Add worktree',
  'rungraph.toolbar.validation': 'Validation',
  'rungraph.toolbar.validationOk': 'No problems found',
  'rungraph.toolbar.saved': 'Graph saved',
  'rungraph.toolbar.saveFailed': 'Failed to save graph',
  'rungraph.editor.nodeTitle': 'Node title',
  'rungraph.editor.agent': 'Agent',
  'rungraph.editor.models': 'Models',
  'rungraph.editor.prompt': 'Prompt template',
  'rungraph.editor.promptHint': 'Use variables like {{name}} to include connected inputs.',
  'rungraph.editor.worktree': 'Worktree',
  'rungraph.editor.nodeWorktree': 'Node worktree',
  'rungraph.editor.nodeWorktreeNone': 'Project root',
  'rungraph.editor.selectNodeHint': 'Select a run or worktree node to edit it.',
  'rungraph.empty.title': 'Start building your graph',
  'rungraph.sessions.title': 'Sessions',
  'rungraph.editor.inputs': 'Inputs',
  'rungraph.empty.description': 'Add a run node for an agent prompt and models, then connect outputs into other runs. Worktree nodes run agents in a shared or new git worktree.',
  'rungraph.editor.worktreeInherit': 'Node default',
  'rungraph.editor.worktreeRoot': 'Project root',
  'rungraph.editor.worktreePool': 'Shared: {name}',
  'rungraph.editor.worktreeDedicated': 'New dedicated worktree',
  'rungraph.worktree.kindExisting': 'Existing',
  'rungraph.worktree.kindNew': 'New',
  'rungraph.worktree.path': 'Path',
  'rungraph.worktree.name': 'Name',
  'rungraph.worktree.baseBranch': 'Base branch',
  'rungraph.worktree.setupCommands': 'Setup commands',
  'rungraph.status.pending': 'Pending',
  'rungraph.status.starting': 'Starting',
  'rungraph.status.running': 'Running',
  'rungraph.status.done': 'Done',
  'rungraph.status.failed': 'Failed',
  'rungraph.status.blocked': 'Blocked',
  'rungraph.status.skipped': 'Skipped',
  'rungraph.outputs.title': 'Output',
  'rungraph.outputs.empty': 'No output yet',
  'rungraph.openSession': 'Open session',
  'rungraph.issue.emptyGraph': 'The graph needs at least one run node.',
  'rungraph.issue.duplicateTitle': 'The title "{title}" is used more than once.',
  'rungraph.issue.nodeMissingInstances': '"{title}" needs at least one model.',
  'rungraph.issue.nodeTooManyInstances': '"{title}" exceeds the maximum of 5 models.',
  'rungraph.issue.instanceMissingModel': '"{title}" has a model entry without provider or model.',
  'rungraph.issue.edgeDanglingNode': 'A connection references a missing node.',
  'rungraph.issue.edgeDanglingInstance': 'A connection references a missing model output.',
  'rungraph.issue.edgeDuplicate': 'A duplicate connection exists between the same output and node.',
  'rungraph.issue.edgeSelf': 'A node cannot be its own input.',
  'rungraph.issue.edgeCycle': '"{title}" is part of a dependency cycle.',
  'rungraph.issue.templateSyntax': '"{title}" has an invalid template expression.',
  'rungraph.issue.templateNoInputs': '"{title}" references "{name}" but nothing is connected to it.',
  'rungraph.issue.templateInputRange': '"{title}" references "{name}[N]" but the input has fewer connected values.',
  'rungraph.issue.bindingDangling': 'A node references a missing worktree.',
  'rungraph.issue.worktreeMissingPath': 'Worktree "{title}" needs a path.',
  'rungraph.issue.worktreeMissingName': 'Worktree "{title}" needs a name.',
  'rungraph.issue.worktreeDuplicateTitle': 'The worktree title "{title}" is used more than once.',
  'rungraph.issue.instancePoolDangling': '"{title}" references a missing worktree.',
  'rungraph.issue.sharedWorktree': '{count} runs share the worktree "{title}" and will execute concurrently.',
  'rungraph.issue.worktreeOrphan': 'Worktree "{title}" is not used by any run.',
  'rungraph.editor.nodeInputs': 'Inputs',
  'rungraph.editor.addInput': 'Add input',
  'rungraph.editor.inputName': 'Input name',
  'rungraph.editor.inputNamePlaceholder': 'e.g. topic',
  'rungraph.editor.removeInput': 'Remove input',
  'rungraph.editor.noInputs': 'No named inputs yet. Add one, connect outputs into it, then reference it in the prompt.',
  'rungraph.editor.insertVariable': 'Insert variable',
  'rungraph.issue.edgeInputTargetInvalid': 'A connection into "{title}" does not point at an existing input.',
  'rungraph.issue.inputMissingName': 'Node "{title}" has an input without a name.',
  'rungraph.issue.inputDuplicateName': 'Node "{title}" uses the input name "{name}" more than once.',
  'rungraph.issue.inputInvalidName': 'Node "{title}" has an invalid input name "{name}".',
  'rungraph.issue.templateUnknownInput': 'Node "{title}" references "{name}" but has no input with that name.',
  'rungraph.toolbar.addForm': 'Add form',
  'rungraph.form.badge': 'Form',
  'rungraph.form.noFields': 'No fields yet',
  'rungraph.form.description': 'Form fields become outputs you can connect into run prompts. Each form appears while the graph runs, right before a run needs it.',
  'rungraph.scope.location': 'Save location',
  'rungraph.scope.project': 'Project',
  'rungraph.scope.global': 'Global',
  'rungraph.form.fields': 'Fields',
  'rungraph.form.addField': 'Add field',
  'rungraph.form.fieldTitle': 'Field title',
  'rungraph.form.fieldTitlePlaceholder': 'What is this field for?',
  'rungraph.form.fieldType': 'Type',
  'rungraph.form.fieldType.text': 'Text',
  'rungraph.form.fieldType.textarea': 'Paragraph',
  'rungraph.form.fieldType.number': 'Number',
  'rungraph.form.fieldType.date': 'Date',
  'rungraph.form.fieldType.time': 'Time',
  'rungraph.form.fieldType.select': 'Dropdown',
  'rungraph.form.fieldType.slider': 'Slider',
  'rungraph.form.fieldType.checkbox': 'Checkbox',
  'rungraph.form.removeField': 'Remove field',
  'rungraph.form.fieldPlaceholder': 'Placeholder',
  'rungraph.form.fieldOptions': 'Options (one per line)',
  'rungraph.form.fieldOptionsPlaceholder': 'Option A\nOption B',
  'rungraph.form.fieldMin': 'Min',
  'rungraph.form.fieldMax': 'Max',
  'rungraph.form.fieldStep': 'Step',
  'rungraph.form.fieldRequired': 'Required',
  'rungraph.form.fieldDefault': 'Default value',
  'rungraph.form.fieldDefaultNone': 'None',
  'rungraph.form.defaults': 'Injected defaults',
  'rungraph.form.dialog.description': 'Fill in this form to continue the graph run.',
  'rungraph.form.dialog.submit': 'Submit',
  'rungraph.form.dialog.cancel': 'Cancel',
  'rungraph.form.dialog.enabled': 'Enabled',
  'rungraph.form.dialog.disabled': 'Disabled',
  'rungraph.issue.edgeSourcePortInvalid': 'A connection from "{title}" does not point at an existing output.',
  'rungraph.issue.edgeFormTargetInvalid': 'A connection into "{title}" does not point at an existing form field.',
  'rungraph.issue.formMissingFields': 'Form "{title}" needs at least one field.',
  'rungraph.issue.formFieldMissingTitle': 'Form "{title}" has a field without a title.',
  'rungraph.issue.formFieldDuplicateTitle': 'Form "{title}" uses the field title "{field}" more than once.',
  'rungraph.issue.formFieldSelectOptions': 'Form "{title}" has a dropdown field without options.',
  'rungraph.issue.formFieldSliderBounds': 'Form "{title}" has a slider field without a minimum and maximum value.',
  'rungraph.issue.formFieldRange': 'Form "{title}" has a field whose minimum exceeds its maximum.',
  'rungraph.issue.formUnused': 'Form "{title}" is not connected to any run and will not be shown.',
} as const;
