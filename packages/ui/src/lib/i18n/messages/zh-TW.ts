...
export const dict: Record<I18nKey, string> = {
  ...
  'commandPalette.item.openGraphs': '開啟圖表',
  ...
  // Multi-run graphs
  'layout.mainTab.graphs': '圖表',
  'rungraph.toolbar.new': '新增',
  'rungraph.toolbar.save': '儲存',
  'rungraph.toolbar.delete': '刪除',
  'rungraph.toolbar.run': '執行',
  'rungraph.toolbar.stop': '停止',
  'rungraph.toolbar.addRun': '新增執行節點',
  'rungraph.toolbar.addWorktree': '新增工作樹',
  'rungraph.toolbar.validation': '驗證',
  'rungraph.toolbar.validationOk': '未發現問題',
  'rungraph.toolbar.saved': '圖表已儲存',
  'rungraph.toolbar.saveFailed': '儲存圖表失敗',
  'rungraph.editor.nodeTitle': '節點標題',
  'rungraph.editor.agent': '代理',
  'rungraph.editor.models': '模型',
  'rungraph.editor.prompt': '提示詞範本',
  'rungraph.editor.promptHint': '使用 {{name}} 這類變數引用已連接的輸入。',
  'rungraph.editor.worktree': '工作樹',
  'rungraph.editor.nodeWorktree': '節點工作樹',
  'rungraph.editor.nodeWorktreeNone': '專案根目錄',
  'rungraph.editor.selectNodeHint': '選擇一個執行節點或工作樹節點進行編輯。',
  'rungraph.empty.title': '開始建構圖表',
  'rungraph.sessions.title': '會話',
  'rungraph.editor.inputs': '輸入',
  'rungraph.empty.description': '新增一個包含代理提示詞與模型的執行節點，然後將輸出連接到其他執行。工作樹節點讓代理在共享或新建的 git 工作樹中執行。',
  'rungraph.editor.worktreeInherit': '節點預設',
  'rungraph.editor.worktreeRoot': '專案根目錄',
  'rungraph.editor.worktreePool': '共享：{name}',
  'rungraph.editor.worktreeDedicated': '新增專屬工作樹',
  'rungraph.worktree.kindExisting': '現有',
  'rungraph.worktree.kindNew': '新增',
  'rungraph.worktree.path': '路徑',
  'rungraph.worktree.name': '名稱',
  'rungraph.worktree.baseBranch': '基準分支',
  'rungraph.worktree.setupCommands': '設定命令',
  'rungraph.status.pending': '等待中',
  'rungraph.status.starting': '啟動中',
  'rungraph.status.running': '執行中',
  'rungraph.status.done': '已完成',
  'rungraph.status.failed': '已失敗',
  'rungraph.status.blocked': '已封鎖',
  'rungraph.status.skipped': '已跳過',
  'rungraph.outputs.title': '輸出',
  'rungraph.outputs.empty': '尚無輸出',
  'rungraph.openSession': '開啟會話',
  'rungraph.issue.emptyGraph': '圖表至少需要一個執行節點。',
  'rungraph.issue.duplicateTitle': '標題「{title}」被多次使用。',
  'rungraph.issue.nodeMissingInstances': '「{title}」至少需要一個模型。',
  'rungraph.issue.nodeTooManyInstances': '「{title}」超過了 5 個模型的上限。',
  'rungraph.issue.instanceMissingModel': '「{title}」存在缺少提供者或模型的模型項目。',
  'rungraph.issue.edgeDanglingNode': '某個連線參照了不存在的節點。',
  'rungraph.issue.edgeDanglingInstance': '某個連線參照了不存在的模型輸出。',
  'rungraph.issue.edgeDuplicate': '相同的輸出與節點之間已存在重複連線。',
  'rungraph.issue.edgeSelf': '節點不能作為自己的輸入。',
  'rungraph.issue.edgeCycle': '「{title}」位於依賴循環中。',
  'rungraph.issue.templateSyntax': '「{title}」包含無效的範本表達式。',
  'rungraph.issue.templateNoInputs': '「{title}」參照了「{name}」，但沒有東西連接到它。',
  'rungraph.issue.templateInputRange': '「{title}」參照了「{name}[N]」，但該輸入連接的值不足。',
  'rungraph.issue.bindingDangling': '某個節點參照了不存在的工作樹。',
  'rungraph.issue.worktreeMissingPath': '工作樹「{title}」需要路徑。',
  'rungraph.issue.worktreeMissingName': '工作樹「{title}」需要名稱。',
  'rungraph.issue.worktreeDuplicateTitle': '工作樹標題「{title}」被多次使用。',
  'rungraph.issue.instancePoolDangling': '「{title}」參照了不存在的工作樹。',
  'rungraph.issue.sharedWorktree': '{count} 個執行共享工作樹「{title}」，將並行執行。',
  'rungraph.issue.worktreeOrphan': '工作樹「{title}」沒有被任何執行使用。',
  'rungraph.editor.nodeInputs': '輸入',
  'rungraph.editor.addInput': '新增輸入',
  'rungraph.editor.inputName': '輸入名稱',
  'rungraph.editor.inputNamePlaceholder': '例如：topic',
  'rungraph.editor.removeInput': '刪除輸入',
  'rungraph.editor.noInputs': '尚無命名輸入。新增一個，把輸出連接到它，然後在提示詞中參照。',
  'rungraph.editor.insertVariable': '插入變數',
  'rungraph.issue.edgeInputTargetInvalid': '連向「{title}」的連線沒有指向現有輸入。',
  'rungraph.issue.inputMissingName': '節點「{title}」有輸入缺少名稱。',
  'rungraph.issue.inputDuplicateName': '節點「{title}」多次使用輸入名稱「{name}」。',
  'rungraph.issue.inputInvalidName': '節點「{title}」有無效的輸入名稱「{name}」。',
  'rungraph.issue.templateUnknownInput': '「{title}」參照了「{name}」，但沒有該名稱的輸入。',
  'rungraph.toolbar.addForm': '新增表單',
  'rungraph.form.badge': '表單',
  'rungraph.form.noFields': '尚無欄位',
  'rungraph.form.description': '表單欄位會成為輸出，可以連接到執行提示詞中。每個表單都會在圖形執行期間、執行真正需要它時才顯示。',
  'rungraph.scope.location': '儲存位置',
  'rungraph.scope.project': '專案',
  'rungraph.scope.global': '全域',
  'rungraph.form.fields': '欄位',
  'rungraph.form.addField': '新增欄位',
  'rungraph.form.fieldTitle': '欄位標題',
  'rungraph.form.fieldTitlePlaceholder': '這個欄位的用途是什麼？',
  'rungraph.form.fieldType': '類型',
  'rungraph.form.fieldType.text': '文字',
  'rungraph.form.fieldType.textarea': '段落',
  'rungraph.form.fieldType.number': '數字',
  'rungraph.form.fieldType.date': '日期',
  'rungraph.form.fieldType.time': '時間',
  'rungraph.form.fieldType.select': '下拉選單',
  'rungraph.form.fieldType.slider': '滑桿',
  'rungraph.form.fieldType.checkbox': '核取方塊',
  'rungraph.form.removeField': '刪除欄位',
  'rungraph.form.fieldPlaceholder': '佔位文字',
  'rungraph.form.fieldOptions': '選項（每行一個）',
  'rungraph.form.fieldOptionsPlaceholder': '選項 A\n選項 B',
  'rungraph.form.fieldMin': '最小值',
  'rungraph.form.fieldMax': '最大值',
  'rungraph.form.fieldStep': '步進',
  'rungraph.form.fieldRequired': '必填',
  'rungraph.form.fieldDefault': '預設值',
  'rungraph.form.fieldDefaultNone': '無',
  'rungraph.form.defaults': '注入的預設值',
  'rungraph.form.dialog.description': '請填寫此表單以繼續圖形執行。',
  'rungraph.form.dialog.submit': '送出',
  'rungraph.form.dialog.cancel': '取消',
  'rungraph.form.dialog.enabled': '已啟用',
  'rungraph.form.dialog.disabled': '已停用',
  'rungraph.issue.edgeSourcePortInvalid': '來自「{title}」的連線沒有指向現有輸出。',
  'rungraph.issue.edgeFormTargetInvalid': '連向「{title}」的連線沒有指向現有表單欄位。',
  'rungraph.issue.formMissingFields': '表單「{title}」至少需要一個欄位。',
  'rungraph.issue.formFieldMissingTitle': '表單「{title}」中有欄位缺少標題。',
  'rungraph.issue.formFieldDuplicateTitle': '表單「{title}」多次使用欄位標題「{field}」。',
  'rungraph.issue.formFieldSelectOptions': '表單「{title}」中有下拉欄位沒有選項。',
  'rungraph.issue.formFieldSliderBounds': '表單「{title}」中有滑桿欄位缺少最小值和最大值。',
  'rungraph.issue.formFieldRange': '表單「{title}」中有欄位的最小值大於最大值。',
  'rungraph.issue.formUnused': '表單「{title}」未連接到任何執行，將不會顯示。',
};
